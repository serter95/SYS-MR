                                    ...
                                    <td>
                                      <div id="proveedor_ext">
                                        ...
                                        <div class="promts" style="margin-left: -50px;"> <span id="proveedormodPrompt"></span></div>
                                                ...
                                                <textarea name="motivo" id="motivomod" class="form-control" size="" maxlength="125" placeholder="Motivo de la realización del mantenimiento ..." onKeyUp="validarMotivomod();" onblur="validarMotivomod();" onKeyPress="return soloAlfa(event)" style="display:inline-block; width:80%;"></textarea>
           ...
           <fieldset id="regmaq" style="color:#000;">
            ...
            <table width="100%">
              ...
              <tr>
                ...
                <td >                   <label><b>Responsable:</b></label><br>
<textarea  readonly="readonly" name="responsable" id="responsable"  class="form-control" style="display:inline-block; width:160px;" size=""maxlength="125" placeholder="" onKeyUp="validarResponsablemod();" onblur="validarResponsablemod();"></textarea>   
              ...
              <tr>             
                  <td colspan="2"align="center"> 
                    <label  style="margin-left:-50px;"><b>Motivo:</b></label><br>                
                     <textarea readonly="readonly" type="text" name="motivo" id="motivo" class="form-control" style="width:160px; margin-left:-50px" size="" maxlength="30" placeholder="" onKeyPress="return soloLetras(event)" ></textarea> 
                   </td>
     ...
     <table width="100%">
      ...
      <tr>
        ...
        <td colspan="">
         ...
         <td align="center">
                  <label  style="margin-left:-50px;"><b>Motivo:</b></label><br>
                  <textarea readonly="readonly" type="text" name="motivo" id="motivo2" class="form-control" style="width:160px; margin-left:-50px" size="" maxlength="30" placeholder="" onKeyPress="return soloLetras(event)" ></textarea>
                </td>
