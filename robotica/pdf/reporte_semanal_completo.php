...
$datos=pg_query("SELECT * FROM planificacion_semanal ps, personal p WHERE ps.id_personal=p.id AND ps.estatus=1 AND p.estatus=1 AND ps.fecha BETWEEN  '".$desde."' AND '".$hasta."'");
$datos2=pg_query("SELECT * FROM planificacion_semanal ps, personal p WHERE ps.id_personal=p.id AND ps.estatus=1 AND p.estatus=1 AND ps.fecha BETWEEN  '".$desde."' AND '".$hasta."'");
