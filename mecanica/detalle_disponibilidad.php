<?php
	...
	$query=pg_query("SELECT * FROM personal WHERE id='$id_personal' AND area='Mecanica' AND estatus=1");
...
<?php
    $query=pg_query("SELECT * FROM horas h, disponibilidad_persona d WHERE h.id_horas=d.id_horas AND 
        d.id_personal='$id_personal' AND d.id_periodo='$id_periodo' AND h.taller=1 AND d.taller=1 AND
