...
$datos=pg_query("SELECT * FROM maquinas WHERE maquina='Taladro' AND estatus='1' AND modificado BETWEEN  '".$desde."' AND '".$hasta."'");
...
//$datos = pg_query ( "SELECT * FROM usuario");
//$datos = pg_query ( "SELECT * FROM usuario");
$datos=pg_query("SELECT * FROM maquinas WHERE estatus='1' ORDER BY codigo ASC");
    ...
    if ($columnas=='0'){
        ...
        while($fila=pg_fetch_assoc($datos)){
            ...
            <tr>
                ...
                <td border="1" style="text-align: center;"><?php echo $fila['n_b'];?></td>
...
<form>
    <fieldset id="fieldset_izquierdo">
        ...
        <table>
            <tr>
                <td>
                    Nº de Taladros Encontrados: <?php echo $columnas; ?>
 
                </td>
            </tr>
             <tr>
                <td>
                    Nº Total de Taladros: <?php echo $taladro; ?>
 
                </td>
            </tr>
            <tr>
                <td>
                    Nº de Taladros Operativos: <?php echo $operativos; ?> 
                </td>
            </tr>
            <tr>
                <td>
                    Nº de Taladros Inoperativos: <?php echo $inoperativos; ?>
                </td>
            </tr>
        </table>
    </fieldset>
...
$html2pdf -> Output('reporte_taladro_rango_'.$d.'-'.$m.'-'.$y.'.pdf','I');
?>