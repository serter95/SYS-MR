...
<head>
    ...
    //<![CDATA[
        drex_file_name = "modificar_insumo.php";
    //]]>
    </script>

    		<title>3.5.2.2. Modificar Insumo</title>
...
<li class="b-breadCrumbs__item">3.5.2.2. Modificar Insumo</li>
</ul>                    </div>
                </td>
                <td id="headerSide__buttons" class="b-article__headerSide m-article__headerSide__buttons">
                    <div class="b-controlButtons">
                        <ul class="b-controlButtons__items">
                            <li class="b-controlButtons__item m-controlButtons__item__prev"><a href="agregar_insumo.php" class="b-controlButtons__link" title="Anterior"><span class="b-controlButtons__link_icon"></span><span class="b-controlButtons__link_text">&#xa0;Anterior</span></a></li>
                            <li class="b-controlButtons__item m-controlButtons__item__next"><a href="primera_parte_del_formulario_2.php" class="b-controlButtons__link" title="Siguiente"><span class="b-controlButtons__link_text">Siguiente&#xa0;</span><span class="b-controlButtons__link_icon"></span></a></li>
                                                </ul>
                    </div>
                </td>
            </tr>
                    ...
                    .append(
                        ...
                        .append(
                            ...
                            .append(
                                ...
                                .html($("<ul></ul>").addClass("b-controlButtons__items").html("    <li class=\"b-controlButtons__item m-controlButtons__item__prev\"><a href=\"agregar_insumo.php\" class=\"b-controlButtons__link\" title=\"Anterior\"><span class=\"b-controlButtons__link_icon\"></span><span class=\"b-controlButtons__link_text\">&#xa0;Anterior</span></a></li>\n    <li class=\"b-controlButtons__item m-controlButtons__item__next\"><a href=\"primera_parte_del_formulario_2.php\" class=\"b-controlButtons__link\" title=\"Siguiente\"><span class=\"b-controlButtons__link_text\">Siguiente&#xa0;</span><span class=\"b-controlButtons__link_icon\"></span></a></li>\n"))
                            )
                        )
                    )
                );
...
<div id="hiddenContent" class="hiddenContent">
    ...
    <div>Para mostrar esto en esta página se necesita que active el JavaScript.</div>
                ...
                <div class="description_on_page"><div class="p" style="text-align: center; direction: ltr; margin-left: 0px; text-indent: 0px;"><div class="ic"><h1><strong>3.5.2.2. Modificar Insumo</strong></h1></div></div>
<div class="p" style="text-align: left; direction: ltr; margin-left: 0px; text-indent: 0px;">En este tema se explicará como podremos modificar los datos de un insumo en el sistema.</div>
<div class="p" style="text-align: left; direction: ltr; margin-left: 0px; text-indent: 0px;">&#160;</div>
<div class="p" style="text-align: justify; direction: ltr; margin-left: 0px; text-indent: 0px;">Primeramente en la pantalla principal del módulo de insumos presionamos el bóton de modificar al insumo a la cual queremos modificarle los datos. (Vease. Navegación: <a class="local_link" href="modulo_de_insumos.php"><span class="de_2B94C39861">Módulo de Insumos</span></a> )</div>
...
<div class="p" style="text-align: left; direction: ltr; margin-left: 0px; text-indent: 0px;">&#160;</div>
<div class="p" style="text-align: left; direction: ltr; margin-left: 0px; text-indent: 0px;"><img  alt="" style="border: solid 0px;  " width="1024" height="560" class=" de_780D01ADE8" src="drex_modificar_insumo_custom.png"/></div>
</div>                	<div class="menu_on_page">
		<h2>Contenido 3.5.2.2. Modificar Insumo</h2>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="primera_parte_del_formulario_2.php">Primera parte del formulario</a></span>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="segunda_parte_del_formulario_2.php">Segunda parte del formulario</a></span>
</div>	</div>
