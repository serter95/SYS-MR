<?php
    ...
    $valores=pg_query("SELECT * FROM prestamo p, personal s WHERE p.id_herramienta='$id' AND p.id_personal=s.id AND p.estado_prestamo='Activo' AND p.estatus=1 AND s.estatus=1");
