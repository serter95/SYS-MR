                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                        ...
                        <?php
                          ...
                          if ($array['priv_maquinas']!='0')
                          {
                        ?>  
                          <li><a href="maquinas.php"><span class="t-submenu">Control de Máquinas</span></a></li>
                          <li><a href="mantenimiento.php"><span class="t-submenu">Mantenimiento</span></a></li>
                        <?php
                          }
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                        ...
                        <?php
                          ...
                          {
                        ?>
                          <li><a href="BD.php" ><span class="t-submenu">Base de datos</span></a></li>
                        <?php
                          }
