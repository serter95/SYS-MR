            ...
            <table width="100%">
              ...
              <td colspan="3" align="center" >
                ...
                <td colspan="2">
                  ...
                  <input type="text" style="text-transform:capitalize;" name="codigo" id="codigo" onkeyup="existeCodigo()" onblur="codemaquinas(); existeCodigo();" maxlength="30" placeholder="Ejemplo:To-00" title="Código de la máquina">
              ...
              <tr>
                <td>
                  ...
                  <input type="text" name="ci_usu" id="ci_usu" onblur="personal_mant(); validarCI();" maxlength="9" placeholder="Ejemplo:12345678" title="Coloque la cedula de identidad de la persona" onKeyUp="validarCI()" onchange="validarCI()"/>
        ...
        <tr>
          ...
          <tr>
            <td colspan="2">
              ...
              <input type="text" style="text-transform:capitalize;" name="codigo" id="codigo2" onblur="codemaquinas(); existeCodigo2();" maxlength="30" placeholder="Ejemplo:To-00" title="Código de la máquina"/>
          ...
          <tr>
            <td>
              ...
              <input type="text" name="ci_usu" id="ci_usu2" onblur="personal_mant(); validarCI2();" onkeyup="validarCI2()" maxlength="9" placeholder="Ejemplo:12345678" title="Coloque la cedula de identidad de la persona" onKeyUp="validarCI2()" onchange="validarCI2()"/>
          ...
          <tr>
            <td>
              ...
              <div class="promts" style="margin-left: 84px; margin-top: -90px;"> <span id="proveedorPrompt"></span></div><p style="display:inline-block; font-size:30px; position:absolute; color:red; margin-left: 250px; margin-top: -40px; ">*</p>
            ...
            <td>
              ...
              <div class="promts" style="margin-left: 84px; margin-top: -90px;"> <span id="responsable2Prompt"></span></div><p style="display:inline-block; font-size:30px; position:absolute; color:red; margin-left: 250px; margin-top: -40px;">*</p>
