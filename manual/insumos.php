...
<head>
    ...
    //<![CDATA[
        drex_file_name = "insumos.php";
    //]]>
    </script>

    		<title>3.5.2. Insumos</title>
...
<li class="b-breadCrumbs__item">3.5.2. Insumos</li>
</ul>                    </div>
                </td>
                <td id="headerSide__buttons" class="b-article__headerSide m-article__headerSide__buttons">
                    <div class="b-controlButtons">
                        <ul class="b-controlButtons__items">
                            <li class="b-controlButtons__item m-controlButtons__item__prev"><a href="devolver_herramienta.php" class="b-controlButtons__link" title="Anterior"><span class="b-controlButtons__link_icon"></span><span class="b-controlButtons__link_text">&#xa0;Anterior</span></a></li>
                            <li class="b-controlButtons__item m-controlButtons__item__next"><a href="agregar_insumo.php" class="b-controlButtons__link" title="Siguiente"><span class="b-controlButtons__link_text">Siguiente&#xa0;</span><span class="b-controlButtons__link_icon"></span></a></li>
                                                </ul>
                    </div>
                </td>
            </tr>
                    ...
                    .append(
                        ...
                        .append(
                            ...
                            .append(
                                ...
                                .html($("<ul></ul>").addClass("b-controlButtons__items").html("    <li class=\"b-controlButtons__item m-controlButtons__item__prev\"><a href=\"devolver_herramienta.php\" class=\"b-controlButtons__link\" title=\"Anterior\"><span class=\"b-controlButtons__link_icon\"></span><span class=\"b-controlButtons__link_text\">&#xa0;Anterior</span></a></li>\n    <li class=\"b-controlButtons__item m-controlButtons__item__next\"><a href=\"agregar_insumo.php\" class=\"b-controlButtons__link\" title=\"Siguiente\"><span class=\"b-controlButtons__link_text\">Siguiente&#xa0;</span><span class=\"b-controlButtons__link_icon\"></span></a></li>\n"))
                            )
                        )
                    )
                );
...
<div id="hiddenContent" class="hiddenContent">
    ...
    <div>Para mostrar esto en esta página se necesita que active el JavaScript.</div>
                ...
                <div class="description_on_page"><div class="p" style="text-align: center; direction: ltr; margin-left: 0px; text-indent: 0px;"><div class="ic"><h1><strong>3.5.2. Insumos</strong></h1></div></div>
<div class="p" style="text-align: justify; direction: ltr; margin-left: 0px; text-indent: 0px;">En este módulo el encargado podrá Agregar, Modificar, Eliminar, Generar Reportes, Permitir la Entrada y Salida de los insumos. Dependiendo de los privilegios del usuario, algunas de las opciones no se visualizarán</div>
</div>                	<div class="menu_on_page">
		<h2>Contenido 3.5.2. Insumos</h2>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="agregar_insumo.php">3.5.2.1. Agregar Insumo</a></span>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="modificar_insumo.php">3.5.2.2. Modificar Insumo</a></span>
</div><div class="m-workZone_seeAlso_itemContent">
	<span class="b-tree__spacer">
		<span class="b-tree__i_article">
			<span class="b-tree__i_article_inner"></span>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="eliminar_insumos.php">3.5.2.3. Eliminar Insumos</a></span>
</div><div class="m-workZone_seeAlso_itemContent">
	<span class="b-tree__spacer">
		<span class="b-tree__i_article">
			<span class="b-tree__i_article_inner"></span>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="detalle_insumo.php">3.5.2.4. Detalle Insumo</a></span>
</div><div class="m-workZone_seeAlso_itemContent">
	<span class="b-tree__spacer">
		<span class="b-tree__i_article">
			<span class="b-tree__i_article_inner"></span>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="reporte_del_insumo.php">3.5.2.5. Reporte del Insumo</a></span>
</div><div class="m-workZone_seeAlso_itemContent">
	<span class="b-tree__spacer">
		<span class="b-tree__i_article">
			<span class="b-tree__i_article_inner"></span>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="entrada_de_insumo.php">3.5.2.6. Entrada de Insumo</a></span>
</div><div class="m-workZone_seeAlso_itemContent">
	<span class="b-tree__spacer">
		<span class="b-tree__i_article">
			<span class="b-tree__i_article_inner"></span>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="salida_de_insumo.php">3.5.2.7. Salida de Insumo</a></span>
</div>	</div>
