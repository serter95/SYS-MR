                              ...
                              <tbody>
                                <?php
                                        $sql="SELECT * FROM tipo_usuario INNER JOIN (usuario INNER JOIN personal
                                          ON usuario.id_personal = personal.id AND area='Mecanica' AND personal.estatus=1) 
                  ...
                  <tr>
                    ...
                    <td class="tit">        
                      ...
                      <select id="tipo" name="tipo" title="Seleccione el tipo de usuario" onchange="validarTIPO()">
                        <option> </option>
                        <?php
                          $sqll="SELECT * FROM tipo_usuario WHERE area In ('Mecanica' , 'Doble') AND estatus=1 AND visible=1";
