<?php
 ...
 #   echo $id;
    ...
    pg_query("UPDATE convenios SET estatus='0' WHERE id_convenio='".$id."'");
    //pg_query("DELETE FROM maquinas WHERE id_maquina='".$id."'");
#   Actualizamos los rerigistros y los obtenemos

    $sql="SELECT * FROM convenio WHERE estatus='1'";
    $query=pg_query($sql);
    ...
    date_default_timezone_set('America/Caracas');
          ...
          pg_query("INSERT INTO auditoria (fecha,accion_realizada,modulo,nom_usuario,taller)
              VALUES('$hoy','Eliminación','Convenios','".$_SESSION['nom_usuario']."',1)");

    header("Location:convenios.php?elim_maq=si");
