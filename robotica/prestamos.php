                  ...
                  <br>
                      ...
                      <div class="dataTable_wrapper">
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                          ...
                          <tbody>
                            <?php
                            $sql="SELECT * FROM herramientas h, prestamo p WHERE h.id_herramienta=p.id_herramienta AND h.estatus=1 AND p.estatus=1 AND h.taller=2";
                           ...
                           $fechac=$fecha." ".$time." ".$meridiano;
                            ...
                            <tr class="odd gradeX">
                              ...
                              <td align="center">
                                <?php 
                                if($array['estado_prestamo']!="Concluido"){
                                  ?>
