...
JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activar columna ascendente",sSortDescending:": activar columna descendente"},oPaginate:{sFirst:"Primera",sLast:"Ultima",sNext:"Siguiente",sPrevious:"Anterior"},sEmptyTable:"No hay datos en la tabla",sInfo:"Mostrando del _START_ al _END_ de un total de _TOTAL_ entradas",sInfoEmpty:"Mostrando 0 de 0 de 0 entradas",sInfoFiltered:"(filtradas de _MAX_ entradas en total)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrar _MENU_ entradas",sLoadingRecords:"Cargando...",sProcessing:"Procesando...",sSearch:"Buscar:",sSearchPlaceholder:"Nombre de la maquina",sUrl:"",sZeroRecords:"Ningun parametro encontrado"},oSearch:h.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};V(m.defaults);m.defaults.column={aDataSort:null,iDataSort:-1,
