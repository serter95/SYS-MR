<?php
  ...
  $query=pg_query("SELECT * FROM usuario u, tipo_usuario t WHERE u.id_tipo_usuario=t.id_tipo AND u.estatus=1
    AND t.estatus=1 AND u.nom_usuario='".$_SESSION['nom_usuario']."' AND u.taller=1");
                            ...
                            <div id="tabla_usuario">
                              ...
                              <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                  ...
                                  <tbody>
                                  <?php
                                    $sql="SELECT * FROM tipo_usuario WHERE area In ('Mecanica') AND estatus=1 AND visible=1";
                                    $query=pg_query($sql);
                                  ...
                                  ?>
                                    <tr class="odd gradeX">
                                      ...
                                      <td align="center">
                                        ...
                                        <?php
                                            $con=pg_query("SELECT * FROM usuario WHERE id_tipo_usuario='".$array['id_tipo']."' AND estatus=1 AND taller=1");
                                            $num=pg_num_rows($con);
                                            ...
                                            <div class="table-responsive">
                                              <table class="table table-hover">
                                                ...
                                                <tbody>
                                                  ...
                                                  <tr>
                                                    <td>Control de Maquinas</td>
                                                    <td><input id="padm1" type="checkbox" name="padm1" value="A"/></td>
                                                    <td><input id="padm2" type="checkbox" name="padm2" value="E"/></td>
                                                    <td><input id="padm3" type="checkbox" name="padm3" value="M"/></td>
                                                    <td><input id="padm4" type="checkbox" name="padm4" value="I"/></td>
                                                    <td><input id="padm5" type="checkbox" name="padm5" value="T"/></td>
                                                  </tr>
                                                  <tr>
                                                    <td>Personal</td>
                                                        ...
                                                        <div class="table-responsive">
                                                          <table class="table table-hover">
                                                            ...
                                                            <tbody>
                                                              ...
                                                              <tr>
                                                                <td>Base de Datos</td>
                                                                <td><input id="BDsi" type="radio" name="BD" value="si"/></td>
                                                                <td><input id="BDno" type="radio" name="BD" value="no" checked="checked"/></td>
                                                              </tr>
                                                              <tr>
                                                                <td>Auditoría</td>
                                                      ...
                                                      <div class="table-responsive">
                                                        <table class="table table-hover">
                                                          ...
                                                          <tbody>
                                                            ...
                                                            <tr>
                                                              <td>Control de Maquinas</td>
                                                              <td><input id="padm1M" type="checkbox" name="padm1M" value="A"/></td>
                                                              <td><input id="padm2M" type="checkbox" name="padm2M" value="E"/></td>
                                                              <td><input id="padm3M" type="checkbox" name="padm3M" value="M"/></td>
                                                              <td><input id="padm4M" type="checkbox" name="padm4M" value="I"/></td>
                                                              <td><input id="padm5M" type="checkbox" name="padm5M" value="T"/></td>
                                                            </tr>
                                                            <tr>
                                                              <td>Personal</td>
                                                                  ...
                                                                  <div class="table-responsive">
                                                                    <table class="table table-hover">
                                                                      ...
                                                                      <tbody>
                                                                        ...
                                                                        <tr>
                                                                          <td>Base de Datos</td>
                                                                          <td><input id="BDsiM" type="radio" name="BDM" value="si"/></td>
                                                                          <td><input id="BDnoM" type="radio" name="BDM" value="no" checked="checked"/></td>
                                                                        </tr>
                                                                        <tr>
                                                                          <td>Auditoría</td>
                                                      ...
                                                      <div class="table-responsive">
                                                        <table class="table table-hover">
                                                          ...
                                                          <tbody>
                                                            ...
                                                            <tr>
                                                              <td>Control de Maquinas</td>
                                                              <td><input disabled id="padm1D" type="checkbox"/></td>
                                                              <td><input disabled id="padm2D" type="checkbox"/></td>
                                                              <td><input disabled id="padm3D" type="checkbox"/></td>
                                                              <td><input disabled id="padm4D" type="checkbox"/></td>
                                                              <td><input disabled id="padm5D" type="checkbox"/></td>
                                                            </tr>
                                                            <tr>
                                                              <td>Personal</td>
                                                                  ...
                                                                  <div class="table-responsive">
                                                                    <table class="table table-hover">
                                                                      ...
                                                                      <tbody>
                                                                        ...
                                                                        <tr>
                                                                          <td>Base de Datos</td>
                                                                          <td><input disabled id="BDsiD" type="radio"/></td>
                                                                          <td><input disabled id="BDnoD" type="radio"/></td>
                                                                        </tr>
                                                                        <tr>
                                                                          <td>Auditoría</td>
