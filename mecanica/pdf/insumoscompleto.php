...
//$datos = pg_query ($conexion, "SELECT * FROM usuario");
$datos=pg_query("SELECT * FROM insumos i, numero_bien n WHERE i.n_b=n.id_nb AND i.estatus='1' AND i.taller=1");
$datos2=pg_query("SELECT importe FROM insumos WHERE estatus='1'AND taller=1");
...
$total_insumos=pg_query("SELECT * FROM insumos WHERE estatus='1' AND taller=1");
...
?>
    ...
    <table class="tabledate">
         <tr>
            ...
            <td border="1" class="td_title" width="100">Nombre</td>
            <td border="1" class="td_title" width="100">Medida</td>
            <td border="1" class="td_title" width="70">Precio Unit.</td>
            <td border="1" class="td_title" width="50">Estante</td>
...
<?php
        ...
        while($fila=pg_fetch_assoc($datos)){
            ...
            <tr>
                ...
                <td border="1" style="text-align: center;" width="100"><?php echo $fila['nombre'];?></td>
                <td border="1" style="text-align: center;" width="100"><?php echo $fila['medida']." ".$fila["tipo_medida"];?></td>
                <td border="1" style="text-align: center;" width="70"><?php echo $fila['precio_unitario'];?></td>
                <td border="1" style="text-align: center;" width="50"><?php echo $fila['estante'];?></td>
