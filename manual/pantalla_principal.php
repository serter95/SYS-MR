...
<head>
    ...
    //<![CDATA[
        drex_file_name = "pantalla_principal.php";
    //]]>
    </script>

    		<title>2.1. Pantalla Principal</title>
...
<li class="b-breadCrumbs__item">2.1. Pantalla Principal</li>
</ul>                    </div>
                </td>
                <td id="headerSide__buttons" class="b-article__headerSide m-article__headerSide__buttons">
                    <div class="b-controlButtons">
                        <ul class="b-controlButtons__items">
                            <li class="b-controlButtons__item m-controlButtons__item__prev"><a href="navegacion.php" class="b-controlButtons__link" title="Anterior"><span class="b-controlButtons__link_icon"></span><span class="b-controlButtons__link_text">&#xa0;Anterior</span></a></li>
                            <li class="b-controlButtons__item m-controlButtons__item__next"><a href="identificando_los_elementos_en_pantalla_principal.php" class="b-controlButtons__link" title="Siguiente"><span class="b-controlButtons__link_text">Siguiente&#xa0;</span><span class="b-controlButtons__link_icon"></span></a></li>
                                                </ul>
                    </div>
                </td>
            </tr>
                    ...
                    .append(
                        ...
                        .append(
                            ...
                            .append(
                                ...
                                .html($("<ul></ul>").addClass("b-controlButtons__items").html("    <li class=\"b-controlButtons__item m-controlButtons__item__prev\"><a href=\"navegacion.php\" class=\"b-controlButtons__link\" title=\"Anterior\"><span class=\"b-controlButtons__link_icon\"></span><span class=\"b-controlButtons__link_text\">&#xa0;Anterior</span></a></li>\n    <li class=\"b-controlButtons__item m-controlButtons__item__next\"><a href=\"identificando_los_elementos_en_pantalla_principal.php\" class=\"b-controlButtons__link\" title=\"Siguiente\"><span class=\"b-controlButtons__link_text\">Siguiente&#xa0;</span><span class=\"b-controlButtons__link_icon\"></span></a></li>\n"))
                            )
                        )
                    )
                );
...
<div id="hiddenContent" class="hiddenContent">
    ...
    <div>Para mostrar esto en esta página se necesita que active el JavaScript.</div>
                ...
                <div class="description_on_page"><div class="p" style="text-align: center; direction: ltr; margin-left: 0px; text-indent: 0px;"><div class="ic"><h1><strong>2.1. Pantalla Principal</strong></h1></div></div>
<div class="p" style="text-align: left; direction: ltr; margin-left: 0px; text-indent: 0px;">&#160;</div>
<div class="p" style="text-align: left; direction: ltr; margin-left: 0px; text-indent: 0px;">&#160;</div>
<div class="p" style="text-align: left; direction: ltr; margin-left: 0px; text-indent: 0px;"><img  alt="" style="border: solid 0px;  " width="790" height="560" class=" de_780D01ADE8" src="drex_pantalla_principal_custom.png"/></div>
</div>                	<div class="menu_on_page">
		<h2>Contenido 2.1. Pantalla Principal</h2>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="identificando_los_elementos_en_pantalla_principal.php">2.1.1. Identificando los elementos en pantalla principal</a></span>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="identificando_los_elementos_en_el_modulo_administrativo.php">2.1.2. Identificando los elementos en el m&#x00F3;dulo Administrativo</a></span>
</div><div class="m-workZone_seeAlso_itemContent">
	<span class="b-tree__spacer">
		<span class="b-tree__i_article">
			<span class="b-tree__i_article_inner"></span>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="identificando_los_elementos_en_el_modulo_academico.php">2.1.3. Identificando los elementos en el m&#x00F3;dulo Acad&#x00E9;mico</a></span>
</div><div class="m-workZone_seeAlso_itemContent">
	<span class="b-tree__spacer">
		<span class="b-tree__i_article">
			<span class="b-tree__i_article_inner"></span>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="identificando_los_elementos_en_el_modulo_configuracion.php">2.1.4. Identificando los elementos en el m&#x00F3;dulo Configuraci&#x00F3;n</a></span>
</div>	</div>
