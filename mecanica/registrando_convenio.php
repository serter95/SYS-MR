...
//$recibiendo2=trim($_REQUEST["rev_maquina"])&&trim($_REQUEST["fecha"])&&trim($_REQUEST["niv_aceite"]);
		...
		$sqlm="INSERT INTO convenios(titulo,ente1,ente2,contratante,contratado,fecha_inicio,fecha_final,taller)VALUES('".$titulo."','".$ente1."','".$ente2."','".$contratante."','".$contratado."','".$fechai."','".$fechaf."','1')";
		pg_query($sqlm);
		...
		date_default_timezone_set('America/Caracas');
          ...
          pg_query("INSERT INTO auditoria (fecha,accion_realizada,modulo,nom_usuario,taller)
              VALUES('$hoy','Registro','Convenios','".$_SESSION['nom_usuario']."',1)");
