<input type="hidden" id="validar_nb" name="validar_nb" />
...
switch($contacto){
	case "0":
?>
	<br><div class="info"><p>Seleccione una máquina por favor</p></div>
			...
			<div id="form_contenedor">
				<form action="registrando_maq.php" method="post" id="reg_maquina" name="reg_maquina" onSubmit="return validarForm()" enctype="multipart/form-data" >
					<fieldset id="regmaq"> 
					 	...
					 	<input type="text" name="n_b" title="Ingrese el número del bien" id="N/B" size="" maxlength="10" placeholder="0978656" onKeyPress="return solonum(event)"  onclick="validarN_B()" onchange="validarN_B()" onKeyUp="validarN_B()">
					 	...
					 	<label>Marca</label>
					  	<input type="text" name="marca" title="Ingrese la marca de la máquina" id="marca" size="" maxlength="8" placeholder="C.M.E" onKeyUp="validarMarca()">
					  	<div class="promts"><span id="marcaPrompt"></span></div><p style="display:inline-block; font-size:30px; position:absolute; color:red;">*</p>
					 	
					 	<label>Modelo</label>
					  	<input type="text" name="modelo" title="Ingrese el modelo de la máquina" id="modelo" size="" maxlength="8" placeholder="FU-2" onKeyUp="validarModelo()">
...
?>
	<div class="info2">
	<div id="text_center_title"> <!--para la parte de titulo--> 
		 			<span>Registro de Máquinas </span>
				</div>
			<div id="form_contenedor">
				<form action="registrando_maq.php" method="post" id="reg_maquina" name="reg_maquina" onSubmit="return validarForm()" enctype="multipart/form-data">
					<fieldset id="regmaq"> 
