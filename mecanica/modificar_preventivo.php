...
if ($imprevisto=="No"){
			...
			horas_hombre='".$hora_hombre."', tipo_servicio='".$servicio."',costo='".$costo."',proveedor='".$proveedor."',
			 responsable='".$responsable."', imprevisto='".$imprevisto."', fecha_imprevisto='".$fechai."', detalle_imprevisto='".$detallei."', motivo='".$motivo."' WHERE id_preventivo='".$id."'";
		...
		#	 echo $sql2;
			...
			pg_query("INSERT INTO auditoria (fecha,accion_realizada,modulo,nom_usuario,taller)
			    VALUES('$hoy','Modificación','Ejecución de Mantenemiento Preventivo','".$_SESSION['nom_usuario']."',1)");
			...
			luces_tablero='".$luces."',parada_emergencia='".$parada."',pulsadores='".$pulsadores."',observaciones='".$observaciones."',
			horas_hombre='".$hora_hombre."', tipo_servicio='".$servicio."',costo='".$costo."',proveedor='".$proveedor."',
			 responsable='".$responsable."', imprevisto='".$imprevisto."', fecha_imprevisto='".$fechai."', detalle_imprevisto='".$detallei."', motivo='".$motivo."'
