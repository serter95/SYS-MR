	...
	{ 
		...
		if ($valueLun[$j]==1)
		{
			...
			$con=pg_query("SELECT * FROM disponibilidad_persona d, horas h WHERE d.id_horas=h.id_horas AND 
				d.id_personal='$id_personal' AND d.id_periodo='$id_periodo' AND d.taller=2 AND h.taller=2
			...
			if ($BloqueLunes[$i][$numero]==1)
			{
				$con2=pg_query("SELECT * FROM horario_clase WHERE id_periodo='$id_periodo' AND
					dia='$diaLun[$j]' AND id_personal='$id_personal' AND taller=2 AND estatus=1");
				$num=pg_num_rows($con2);

				if ($num==0)
				{
					$con3=pg_query("SELECT * FROM horario_clase WHERE id_periodo='$id_periodo' AND
						dia='$diaLun[$j]' AND aula='$aulaLun[$j]' AND taller=2 AND estatus=1");
					$num2=pg_num_rows($con3);

					if ($num2==0)
					{
						$q=pg_query("SELECT * FROM materia WHERE codigo='$codMatLun[$j]' AND taller=2 AND estatus=1");
						$a=pg_fetch_assoc($q);
						...
						$sql="INSERT INTO horario_clase (id_seccion, id_materia, id_personal, id_horas, id_periodo, dia, aula, taller)VALUES('$id_seccion','$id_materia','$id_personal','$id_horas[$j]'
							,'$id_periodo','$diaLun[$j]','$aulaLun[$j]', '2')";	
		...
		if ($valueMar[$j]==1)
		{
			...
			{
				$con2=pg_query("SELECT * FROM horario_clase WHERE id_periodo='$id_periodo' AND
					dia='$diaMar[$j]' AND id_personal='$id_personal' AND taller=2 AND estatus=1");
				$num=pg_num_rows($con2);

				if ($num==0)
				{
					$con3=pg_query("SELECT * FROM horario_clase WHERE id_periodo='$id_periodo' AND
						dia='$diaMar[$j]' AND aula='$aulaMar[$j]' AND taller=2 AND estatus=1");
					$num2=pg_num_rows($con3);

					if ($num2==0)
					{
						$q=pg_query("SELECT * FROM materia WHERE codigo='$codMatMar[$j]' AND taller=2 AND estatus=1");
						$a=pg_fetch_assoc($q);
						$id_materia=$a['id_materia'];
						...
						$sql="INSERT INTO horario_clase (id_seccion, id_materia, id_personal, id_horas, id_periodo, dia, aula, taller)VALUES('$id_seccion','$id_materia','$id_personal','$id_horas[$j]'
							,'$id_periodo','$diaMar[$j]','$aulaMar[$j]', '2')";	
		...
		if ($valueMie[$j]==1)
		{
			...
			{
				$con2=pg_query("SELECT * FROM horario_clase WHERE id_periodo='$id_periodo' AND
					dia='$diaMie[$j]' AND id_personal='$id_personal' AND taller=2 AND estatus=1");
				$num=pg_num_rows($con2);

				if ($num==0)
				{
					$con3=pg_query("SELECT * FROM horario_clase WHERE id_periodo='$id_periodo' AND
						dia='$diaMie[$j]' AND aula='$aulaMie[$j]' AND taller=2 AND estatus=1");
					$num2=pg_num_rows($con3);

					if ($num2==0)
					{
						$q=pg_query("SELECT * FROM materia WHERE codigo='$codMatMie[$j]' AND taller=2 AND estatus=1");
						$a=pg_fetch_assoc($q);
						$id_materia=$a['id_materia'];
						...
						$sql="INSERT INTO horario_clase (id_seccion, id_materia, id_personal, id_horas, id_periodo, dia, aula, taller)VALUES('$id_seccion','$id_materia','$id_personal','$id_horas[$j]'
							,'$id_periodo','$diaMie[$j]','$aulaMie[$j]', '2')";	
		...
		if ($valueJue[$j]==1)
		{
			...
			{
				$con2=pg_query("SELECT * FROM horario_clase WHERE id_periodo='$id_periodo' AND
					dia='$diaJue[$j]' AND id_personal='$id_personal' AND taller=2 AND estatus=1");
				$num=pg_num_rows($con2);

				if ($num==0)
				{
					$con3=pg_query("SELECT * FROM horario_clase WHERE id_periodo='$id_periodo' AND
						dia='$diaJue[$j]' AND aula='$aulaJue[$j]' AND taller=2 AND estatus=1");
					$num2=pg_num_rows($con3);

					if ($num2==0)
					{
						$q=pg_query("SELECT * FROM materia WHERE codigo='$codMatJue[$j]' AND taller=2 AND estatus=1");
						$a=pg_fetch_assoc($q);
						$id_materia=$a['id_materia'];
						...
						$sql="INSERT INTO horario_clase (id_seccion, id_materia, id_personal, id_horas, id_periodo, dia, aula, taller)VALUES('$id_seccion','$id_materia','$id_personal','$id_horas[$j]'
							,'$id_periodo','$diaJue[$j]','$aulaJue[$j]', '2')";	
		...
		if ($valueVie[$j]==1)
		{
			...
			{
				$con2=pg_query("SELECT * FROM horario_clase WHERE id_periodo='$id_periodo' AND
					dia='$diaVie[$j]' AND id_personal='$id_personal' AND taller=2 AND estatus=1");
				$num=pg_num_rows($con2);

				if ($num==0)
				{
					$con3=pg_query("SELECT * FROM horario_clase WHERE id_periodo='$id_periodo' AND
						dia='$diaVie[$j]' AND aula='$aulaVie[$j]' AND taller=2 AND estatus=1");
					$num2=pg_num_rows($con3);

					if ($num2==0)
					{
						$q=pg_query("SELECT * FROM materia WHERE codigo='$codMatVie[$j]' AND taller=2 AND estatus=1");
						$a=pg_fetch_assoc($q);
						$id_materia=$a['id_materia'];
						...
						$sql="INSERT INTO horario_clase (id_seccion, id_materia, id_personal, id_horas, id_periodo, dia, aula, taller)VALUES('$id_seccion','$id_materia','$id_personal','$id_horas[$j]'
							,'$id_periodo','$diaVie[$j]','$aulaVie[$j]','2')";	
...
#****************************************************************************************************
	...
	if ($registrar=="exito")
	{
	    ...
	    VALUES('$hoy','Registro','Horarios','".$_SESSION['nom_usuario']."')");
		#echo "<br><br>REGISTRO!!!";
