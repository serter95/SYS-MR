...
//$datos = pg_query ($conexion, "SELECT * FROM usuario");
$maq=$_REQUEST['maq'];
$datos=pg_query("SELECT * FROM maquinas m, numero_bien n WHERE m.n_b=n.id_nb AND m.maquina='$maq' AND m.estatus='1' ORDER BY m.codigo ASC");
...
$total_tornos=pg_query("SELECT maquina FROM maquinas WHERE estatus='1' AND maquina='$maq'");
...
<form>
    <fieldset id="fieldset_izquierdo">
        ...
        <table>
             <tr>
                <td>
                    Nº Total de <?php echo $maq.":"." ".$tornos; ?>
