...
$recibiendo=trim($_REQUEST["nombre"])&&trim($_REQUEST["pre_nb"]);
...
//--------------Pequeña validacion existe nb php-----------
	    ...
	    $id_nb=$array["id_nb"];			
		echo $sqlm="INSERT INTO insumos(nombre,n_b,tipo_medida,medida,precio_unitario,existencia,buenas,danadas,min_stock,importe,ubicacion,max_stock,taller,estante)
		VALUES('".$nombre."','".$id_nb."','".$tipo_medida."','".$medida."','".$precio."','".$existencia."','".$buenas."','".$danadas."','".$min."','".$importe."','".$ubicacion."','".$max."','1','".$estante."')";
		pg_query($sqlm);
