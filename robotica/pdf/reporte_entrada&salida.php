...
$datos=pg_query("SELECT * FROM insumos i , salida s, numero_bien n WHERE i.id_insumos=s.id_insumos AND i.n_b=n.id_nb AND s.tipo='insumo' AND i.estatus='1' AND s.estatus='1' AND i.taller=2 AND realizado BETWEEN  '".$desde."' AND '".$hasta."' ORDER BY realizado DESC");
}
else if($tipo=="entrada"){
$datos=pg_query("SELECT * FROM insumos i , entrada e,  numero_bien n WHERE i.id_insumos=e.id_insumos AND i.n_b=n.id_nb AND e.tipo='insumo' AND i.estatus='1' AND e.estatus='1' AND i.taller=2 AND realizado BETWEEN  '".$desde."' AND '".$hasta."' ORDER BY realizado DESC");
