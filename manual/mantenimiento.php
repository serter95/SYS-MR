...
<head>
    ...
    //<![CDATA[
        drex_file_name = "mantenimiento.php";
    //]]>
    </script>

    		<title>3.7. Mantenimiento</title>
...
<li class="b-breadCrumbs__item">3.7. Mantenimiento</li>
</ul>                    </div>
                </td>
                <td id="headerSide__buttons" class="b-article__headerSide m-article__headerSide__buttons">
                    <div class="b-controlButtons">
                        <ul class="b-controlButtons__items">
                            <li class="b-controlButtons__item m-controlButtons__item__prev"><a href="eliminar_tipo_de_maquina.php" class="b-controlButtons__link" title="Anterior"><span class="b-controlButtons__link_icon"></span><span class="b-controlButtons__link_text">&#xa0;Anterior</span></a></li>
                            <li class="b-controlButtons__item m-controlButtons__item__next"><a href="solicitud_de_mantenimiento.php" class="b-controlButtons__link" title="Siguiente"><span class="b-controlButtons__link_text">Siguiente&#xa0;</span><span class="b-controlButtons__link_icon"></span></a></li>
                                                </ul>
                    </div>
                </td>
            </tr>
                    ...
                    .append(
                        ...
                        .append(
                            ...
                            .append(
                                ...
                                .html($("<ul></ul>").addClass("b-controlButtons__items").html("    <li class=\"b-controlButtons__item m-controlButtons__item__prev\"><a href=\"eliminar_tipo_de_maquina.php\" class=\"b-controlButtons__link\" title=\"Anterior\"><span class=\"b-controlButtons__link_icon\"></span><span class=\"b-controlButtons__link_text\">&#xa0;Anterior</span></a></li>\n    <li class=\"b-controlButtons__item m-controlButtons__item__next\"><a href=\"solicitud_de_mantenimiento.php\" class=\"b-controlButtons__link\" title=\"Siguiente\"><span class=\"b-controlButtons__link_text\">Siguiente&#xa0;</span><span class=\"b-controlButtons__link_icon\"></span></a></li>\n"))
                            )
                        )
                    )
                );
...
<div id="hiddenContent" class="hiddenContent">
    ...
    <div>Para mostrar esto en esta página se necesita que active el JavaScript.</div>
                ...
                <div class="description_on_page"><div class="p" style="text-align: center; direction: ltr; margin-left: 0px; text-indent: 0px;"><div class="ic"><h1><strong>3.7. Mantenimiento</strong></h1></div></div>
<div class="p" style="text-align: center; direction: ltr; margin-left: 0px; text-indent: 0px;">&#160;</div>
<div class="p" style="text-align: justify; direction: ltr; margin-left: 0px; text-indent: 0px;">En este Módulo se prodrá Crear, Controlar y Gestionar la solicitud y la ejecución de los mantenimientos de las maquinas&#160; encontradas en el taller (Área de Metalmécanica), así mismo en esté módulo se podrán devolver los repuestos se hayan sobrado del mantenimieto. (Es decir, el mantenimiento se llevo menos repuestos del que se había sacado).</div>
</div>                	<div class="menu_on_page">
		<h2>Contenido 3.7. Mantenimiento</h2>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="solicitud_de_mantenimiento.php">3.7.1. Solicitud de Mantenimiento</a></span>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="ejecucion_de_mantenimiento_2.php">3.7.2. Ejecuci&#x00F3;n de Mantenimiento</a></span>
</div><div class="m-workZone_seeAlso_itemContent">
	<span class="b-tree__spacer">
		<span class="b-tree__i_article">
			<span class="b-tree__i_article_inner"></span>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="reposicion_de_repuestos_2.php">3.7.3. Reposici&#x00F3;n de Repuestos</a></span>
</div>	</div>
                    			</div>
</body>
</html>
