...
#****************************************************************************************
	...
	for ($i=1; $i <=$ciclo ; $i++)
	{
			...
			if ($BloqueLunes[$i][$numero]==1)
			{
				...
				if ($num==0)
				{
					...
					if ($num2==0)
					{
						...
						$sql="INSERT INTO horario_clase (id_seccion, id_materia, id_personal, id_horas, id_periodo, dia, aula, id_personal2, id_personal3)VALUES('$idSeccion','$id_materia','$id_personal','$id_horas[$j]','$idPeriodo','$diaLun[$j]','$aulaLun[$j]','$id_personal2','$id_personal3')";	
		...
		if ($valueMar[$j]==1)
		{
			...
			{
				$con2=pg_query("SELECT * FROM horario_clase WHERE id_periodo='$idPeriodo' AND
					dia='$diaMar[$j]' AND id_personal='$id_personal' AND estatus=1 AND taller=1");
				$num=pg_num_rows($con2);

				if ($num==0)
				{
					$con3=pg_query("SELECT * FROM horario_clase WHERE id_periodo='$idPeriodo' AND
						dia='$diaMar[$j]' AND aula='$aulaMar[$j]' AND estatus=1 AND taller=1");
					$num2=pg_num_rows($con3);

					if ($num2==0)
					{
						$q=pg_query("SELECT * FROM materia WHERE codigo='$codMatMar[$j]' AND estatus=1 AND taller=1");
						$a=pg_fetch_assoc($q);
						$id_materia=$a['id_materia'];

						$sql="INSERT INTO horario_clase (id_seccion, id_materia, id_personal, id_horas, id_periodo, dia, aula, id_personal2, id_personal3)VALUES('$idSeccion','$id_materia','$id_personal','$id_horas[$j]','$idPeriodo','$diaMar[$j]','$aulaMar[$j]','$id_personal2','$id_personal3')";	
		...
		if ($valueMie[$j]==1)
		{
			...
			{
				$con2=pg_query("SELECT * FROM horario_clase WHERE id_periodo='$idPeriodo' AND
					dia='$diaMie[$j]' AND id_personal='$id_personal' AND estatus=1 AND taller=1");
				$num=pg_num_rows($con2);

				if ($num==0)
				{
					$con3=pg_query("SELECT * FROM horario_clase WHERE id_periodo='$idPeriodo' AND
						dia='$diaMie[$j]' AND aula='$aulaMie[$j]' AND estatus=1 AND taller=1");
					$num2=pg_num_rows($con3);

					if ($num2==0)
					{
						$q=pg_query("SELECT * FROM materia WHERE codigo='$codMatMie[$j]' AND estatus=1 AND taller=1");
						$a=pg_fetch_assoc($q);
						$id_materia=$a['id_materia'];

						$sql="INSERT INTO horario_clase (id_seccion, id_materia, id_personal, id_horas, id_periodo, dia, aula, id_personal2, id_personal3)VALUES('$idSeccion','$id_materia','$id_personal','$id_horas[$j]','$idPeriodo','$diaMie[$j]','$aulaMie[$j]','$id_personal2','$id_personal3')";	
		...
		if ($valueJue[$j]==1)
		{
			...
			{
				$con2=pg_query("SELECT * FROM horario_clase WHERE id_periodo='$idPeriodo' AND
					dia='$diaJue[$j]' AND id_personal='$id_personal' AND estatus=1 AND taller=1");
				$num=pg_num_rows($con2);

				if ($num==0)
				{
					$con3=pg_query("SELECT * FROM horario_clase WHERE id_periodo='$idPeriodo' AND
						dia='$diaJue[$j]' AND aula='$aulaJue[$j]' AND estatus=1 AND taller=1");
					$num2=pg_num_rows($con3);

					if ($num2==0)
					{
						$q=pg_query("SELECT * FROM materia WHERE codigo='$codMatJue[$j]' AND estatus=1 AND taller=1");
						$a=pg_fetch_assoc($q);
						$id_materia=$a['id_materia'];

						$sql="INSERT INTO horario_clase (id_seccion, id_materia, id_personal, id_horas, id_periodo, dia, aula, id_personal2, id_personal3)VALUES('$idSeccion','$id_materia','$id_personal','$id_horas[$j]','$idPeriodo','$diaJue[$j]','$aulaJue[$j]','$id_personal2','$id_personal3')";	
		...
		if ($valueVie[$j]==1)
		{
			...
			{
				$con2=pg_query("SELECT * FROM horario_clase WHERE id_periodo='$idPeriodo' AND
					dia='$diaVie[$j]' AND id_personal='$id_personal' AND estatus=1 AND taller=1");
				$num=pg_num_rows($con2);

				if ($num==0)
				{
					$con3=pg_query("SELECT * FROM horario_clase WHERE id_periodo='$idPeriodo' AND
						dia='$diaVie[$j]' AND aula='$aulaVie[$j]' AND estatus=1 AND taller=1");
					$num2=pg_num_rows($con3);
					...
					if ($num2==0)
					{
						...
						$sql="INSERT INTO horario_clase (id_seccion, id_materia, id_personal, id_horas, id_periodo, dia, aula, id_personal2, id_personal3)VALUES('$idSeccion','$id_materia','$id_personal','$id_horas[$j]','$idPeriodo','$diaVie[$j]','$aulaVie[$j]','$id_personal2','$id_personal3')";	
	...
	if ($registrar=="exito")
	{
		date_default_timezone_set('America/Caracas');
          ...
          pg_query("INSERT INTO auditoria (fecha,accion_realizada,modulo,nom_usuario,taller)
              VALUES('$hoy','Modificación','Horarios','".$_SESSION['nom_usuario']."',1)");
		#echo "<br><br>REGISTRO!!!";
