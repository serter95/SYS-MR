...
function valida_fechamod(){
  ...
  var valor2 = document.getElementById("resultado_fechamod").value;
    ...
    {
  //validaCodigo dunciona para todos WTF  aqui iba !validarCodigo() ||
  if(!validarResponsablemod() || !validarMotivomod() || !validarProveedormod() || !validarObservacionesmod() || !validarHombremod() || !validarCostomod() || !validar_fechaI() || !validar_detalleI() ){
        /*$('#error_incompleto').modal({
                    show:true,
                    backdrop:'static'
                }).show(200);
