...
//$datos = pg_query ($conexion, "SELECT * FROM usuario");
$datos=pg_query("SELECT * FROM maquinas m, mant_preventivo p, personal s, numero_bien n WHERE m.id_maquina=p.maquina_id AND m.n_b=n.id_nb AND p.id_personal=s.id  AND m.estatus='1' AND p.estatus='1'  AND p.estado<>'en proceso' ORDER BY fecha DESC");
$datos2=pg_query("SELECT costo, fecha FROM mant_preventivo WHERE estatus='1' AND estado<>'en proceso' ORDER BY fecha DESC");
    ...
    <table class="tabledate">
         <tr>
            ...
            <td border="1" class="td_title" width="60">Luces T.</td>
             ...
             <td border="1" class="td_title" width="70">Fecha ejecución</td>
