                    ...
                    <table class="table table-striped table-bordered table-hover">                    
                      ...
                      <?php
                         ...
                         $query=pg_query("SELECT * FROM usuario u, tipo_usuario t WHERE u.estatus=1 AND t.estatus=1
                          AND u.id_tipo_usuario=t.id_tipo AND nom_usuario='".$_SESSION['nom_usuario']."' AND u.taller=2");
                    ...
                    <table class="table table-striped table-bordered table-hover">
                          ...
                          <tbody>
                            <?php
                              ...
                              p.id=u.id_personal AND nom_usuario='".$_SESSION['nom_usuario']."' AND u.taller=2";
                              $query=pg_query($sql);
