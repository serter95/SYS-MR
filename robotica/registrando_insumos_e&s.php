...
header("Location:insumos_e&s.php");
}
...
*/
    ...
    VALUES('$hoy','Registro','Salida','".$_SESSION['nom_usuario']."')");
	...
	pg_query("INSERT INTO auditoria (fecha,accion_realizada,modulo,nom_usuario)
    VALUES('$hoy','Registro','Entrada','".$_SESSION['nom_usuario']."')");
