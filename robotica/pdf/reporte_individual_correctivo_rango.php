...
$datos2=pg_query("SELECT costo, fecha_ejecucion FROM mant_correctivo WHERE id_maquina='$id' AND estatus='1' AND estado<>'en proceso' AND fecha_falla BETWEEN  '".$desde."' AND '".$hasta."' ORDER BY fecha_ejecucion DESC");
...
?>
    ...
    <table class="tabledate">
    	<tr>
    		...
    		<td border="1" class="td_title" width="70">Pieza de recambio</td>
    		<td border="1" class="td_title" width="70">Fecha</td>
    		<td border="1" class="td_title" width="100">Descripción</td>
    	...
    	while($fila=pg_fetch_assoc($datos)){
    		$fecha_a=explode('-', $fila['fecha_falla']);
    		$ano=$fecha_a[0];
    		$mes=$fecha_a[1].'/';
    		$dia=$fecha_a[2].'/';
    		$fecha=$dia.$mes.$ano;
    		...
    		<tr>
    			...
    			<td border="1" style="text-align: center;" width="100"><?php echo $fila['descripcion'];?></td>
