...
$datos=pg_query("SELECT * FROM maquinas m, numero_bien n WHERE maquina='Limadora' AND m.n_b=n.id_nb AND estatus='1'");
...
$html2pdf -> Output('reporte_limadoras_'.$d.'-'.$m.'-'.$y.'.pdf','I');
?>