...
<?php if($selector["estado"]!='en proceso'){ ?> <li><a href="#tabpreventivo2" data-toggle="tab">Preventivo II</a></li>
                                                <li><a href="#tabrepuestos" data-toggle="tab">Repuestos Utilizados</a></li>
<?php } ?>
...
?>
                     ...
                     <tr>
                        ...
                        <tr>
                            <td  align="center" colspan="2"><?php echo $arrays['motivo']; ?></td>
                        </tr>
