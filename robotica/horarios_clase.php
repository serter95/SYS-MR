                      ...
                      <tr>
                        <td colspan="2" class="tit">
                          ...
                          <select id="seccion" name="seccion" title="Seleccione la Sección" onchange="valiDiasR('algo')">
                            <option> </option>
                            <?php
                              $con=pg_query("SELECT * FROM secciones WHERE taller=2 AND estatus=1 ORDER BY trayecto, seccion ASC");
                      ...
                      <tr>
                        <td colspan="3">
                          <table border="2" width="100%">
                            ...
                            <?php
                              $query=pg_query("SELECT * FROM horas WHERE estatus=1 AND taller=2 ORDER BY numero_bloque ASC");
                            ...
                            <table width="100%">
                              <tr>
                                ...
                                <td class="tit">
                                  ...
                                  <select id="ci" name="ci" onchange="ValidarBloqueProfe('algo'), nom_ape_horarios()" onblur="nom_ape_horarios()" title="Seleccione la cedula del profesor">
                                    <option> </option>
                                  </select>
                                  <p style="display:inline-block; font-size:30px; position:absolute; color:red;">*</p>
                                ...
                                <td class="tit">
                                  ...
                                  <select id="aula" name="aula" title="Seleccione el aula 'Ejemplo:A5'" onchange="ValidarBloqueProfe('algo2')">
                                    <option> </option>
                                    <?php
                                      $queryx=pg_query("SELECT * FROM aulas WHERE taller=2 AND estatus=1");
                              ...
                              <tr>
                                <td class="tit">
                                  ...
                                  <select id="materia" name="materia" title="Seleccione el código de la materia" onchange="materia_horarios()">
                                    <option> </option>
                                    <?php
                                      $con3=pg_query("SELECT * FROM materia WHERE taller=2 AND estatus=1 ORDER BY codigo ASC");
                        ...
                        <form action="#" method="post" onsubmit="return validarMATERIAS_M()">
                          ...
                          <table width="100%">
                            <tr>
                              ...
                              <td class="tit">
                                <label><b>C.I del Profesor:</b></label><br>
                                <select id="ciM" name="ciM" onchange="ValidarBloqueProfeM('algo'), nom_ape_horariosM()">
                                  <option> </option>
                                </select>
                                <p style="display:inline-block; font-size:30px; position:absolute; color:red;">*</p>
