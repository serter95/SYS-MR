...
//$datos = pg_query ($conexion, "SELECT * FROM usuario");
$datos=pg_query("SELECT * FROM herramientas i, numero_bien n WHERE i.n_b=n.id_nb AND i.estatus='1' AND i.taller=1 AND i.estante=2 LIMIT 1");
...
?>
    ...
    <table class="tabledate">
         <tr>
            <td border="1" class="td_title" width="60">Codigo</td>
            ...
            <td border="1" class="td_title" width="50">Cantidad</td>
...
<?php
        ...
        while($fila=pg_fetch_assoc($datos)){
            ...
            <tr>
                <td class="rose" border="1" style="text-align: center;" width="60"><?php echo $fila['codigo_herramienta'];?></td>
                ...
                <td border="1" style="text-align: center;" width="50"><?php echo $fila['cantidad'];?></td>
