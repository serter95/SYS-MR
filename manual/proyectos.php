...
<head>
    ...
    //<![CDATA[
        drex_file_name = "proyectos.php";
    //]]>
    </script>

    		<title>3.3. Proyectos</title>
...
<li class="b-breadCrumbs__item">3.3. Proyectos</li>
</ul>                    </div>
                </td>
                <td id="headerSide__buttons" class="b-article__headerSide m-article__headerSide__buttons">
                    <div class="b-controlButtons">
                        <ul class="b-controlButtons__items">
                            <li class="b-controlButtons__item m-controlButtons__item__prev"><a href="reporte_de_horario.php" class="b-controlButtons__link" title="Anterior"><span class="b-controlButtons__link_icon"></span><span class="b-controlButtons__link_text">&#xa0;Anterior</span></a></li>
                            <li class="b-controlButtons__item m-controlButtons__item__next"><a href="agregar_proyecto.php" class="b-controlButtons__link" title="Siguiente"><span class="b-controlButtons__link_text">Siguiente&#xa0;</span><span class="b-controlButtons__link_icon"></span></a></li>
                                                </ul>
                    </div>
                </td>
            </tr>
                    ...
                    .append(
                        ...
                        .append(
                            ...
                            .append(
                                ...
                                .html($("<ul></ul>").addClass("b-controlButtons__items").html("    <li class=\"b-controlButtons__item m-controlButtons__item__prev\"><a href=\"reporte_de_horario.php\" class=\"b-controlButtons__link\" title=\"Anterior\"><span class=\"b-controlButtons__link_icon\"></span><span class=\"b-controlButtons__link_text\">&#xa0;Anterior</span></a></li>\n    <li class=\"b-controlButtons__item m-controlButtons__item__next\"><a href=\"agregar_proyecto.php\" class=\"b-controlButtons__link\" title=\"Siguiente\"><span class=\"b-controlButtons__link_text\">Siguiente&#xa0;</span><span class=\"b-controlButtons__link_icon\"></span></a></li>\n"))
                            )
                        )
                    )
                );
...
<div id="hiddenContent" class="hiddenContent">
    ...
    <div>Para mostrar esto en esta página se necesita que active el JavaScript.</div>
                ...
                <div class="description_on_page"><div class="p" style="text-align: center; direction: ltr; margin-left: 0px; text-indent: 0px;"><div class="ic"><h1><strong>3.3. Proyectos</strong></h1></div></div>
<div class="p" style="text-align: justify; direction: ltr; margin-left: 0px; text-indent: 0px;">En este módulo el encargado podrá Agregar, Modificar, Eliminar proyectos socio-tecnológicos y socio-comunitarios en que el sistema. Dependiendo de los privilegios del usuario, algunas de las opciones no se visualizarán. Los temas presentados en este módulo aplican para los dos tipos de proyecto.</div>
<div class="p" style="text-align: justify; direction: ltr; margin-left: 0px; text-indent: 0px;">&#160;</div>
</div>                	<div class="menu_on_page">
		<h2>Contenido 3.3. Proyectos</h2>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="agregar_proyecto.php">3.3.1. Agregar Proyecto</a></span>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="modificar_proyecto.php">3.3.2. Modificar Proyecto</a></span>
</div><div class="m-workZone_seeAlso_itemContent">
	<span class="b-tree__spacer">
		<span class="b-tree__i_article">
			<span class="b-tree__i_article_inner"></span>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="eliminar_proyecto.php">3.3.3. Eliminar Proyecto</a></span>
</div><div class="m-workZone_seeAlso_itemContent">
	<span class="b-tree__spacer">
		<span class="b-tree__i_article">
			<span class="b-tree__i_article_inner"></span>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="estado_proyecto.php">3.3.4. Estado Proyecto</a></span>
</div><div class="m-workZone_seeAlso_itemContent">
	<span class="b-tree__spacer">
		<span class="b-tree__i_article">
			<span class="b-tree__i_article_inner"></span>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="detalle_proyecto.php">3.3.5. Detalle Proyecto</a></span>
</div><div class="m-workZone_seeAlso_itemContent">
	<span class="b-tree__spacer">
		<span class="b-tree__i_article">
			<span class="b-tree__i_article_inner"></span>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="reporte_proyecto.php">3.3.6. Reporte Proyecto</a></span>
</div>	</div>
