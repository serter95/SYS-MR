...
?>
    ...
    <?php if($selector["estado"]!='en proceso'){ ?>  <li><a href="#tabpreventivo2" data-toggle="tab">Correctivo II</a></li> 
                                                    <li><a href="#tabrepuestos" data-toggle="tab">Repuestos Utilizados</a></li><?php } ?>
...
?>
                        ...
                        <tr>
                            <td  align="center" colspan="3"><?php echo $arrays['motivo']; ?></td>
                        </tr>
...
?>
        ...
        <!-- /.panel-body -->
<div class="tab-pane fade" id="tabrepuestos">
                  <div class="panel panel-default">
                    <div class="panel-body">
            <div class="table-responsive">
                <?php 
    $sql3=pg_query("SELECT * FROM repuestos WHERE id_correctivo=".$id." ");
    ...
    ?>
        ...
        if ($R1!=0){
            ...
            <tr>
              ...
              <b>Cantidad de Total de Repuestos Utilizados:</b>
              </td>
            <td border="1" align="center">
            <?php echo $total; ?>
            </td>
        ...
        <?php 
            ...
            ?>
            <div align="center"><span>No posee repuestos</span></div>
            <?php
        }
            ?>
