...
?>
      ...
      <table>
        <tr>
            ...
            <td width="210" border="1"   class="td_title" align="center" style="width:0px;"> 
             ...
             <td border="1" width="210" colspan="2"  class="td_title" align="center" > 
               <label>Nombre</label>
           </td>
        ...
        <td border="1" align="center" width="210" >
        <?php echo $array['nb']; ?> 

        </td>
        <td border="1" align="center" width="210" colspan="2">
        ...
        <label>Estado</label>
         ...
         <tr>
           <td border="1" align="center" width="200">
       ...
       <tr>
        ...
        <td border="1" width="200" height="10"  class="td_title" align="center" > 
        <label>Cantidad en prestamo</label>
        </td> 
         <td border="1" width="200" height="10"  class="td_title" align="center" > 
        ...
        <?php echo $cantidad_actual=(int)$array["cantidad"]-(int)$array["cantidad_p"]; ?> 

        </td>
          <td border="1" align="center">

        <?php echo $array['cantidad_p']; ?> 
   ...
   <?php
    if($array['cantidad_p']>"1"){
       $sqlprestamo="SELECT * FROM herramientas h , prestamo p, personal s WHERE h.id_herramienta='".$id."' AND h.id_herramienta=p.id_herramienta AND p.id_personal=s.id AND h.estatus='1' AND p.estatus='1' AND p.estado_prestamo='Activo'";
       $queryprestamo=pg_query($sqlprestamo);
         while ($fila=pg_fetch_assoc($queryprestamo)) {
           # code...
