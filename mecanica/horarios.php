                    ...
                    <div class="dataTable_wrapper">
                      <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <?php
                         ...
                         $sql="SELECT * FROM materia WHERE taller=1 AND estatus=1";
                    ...
                    <table width="100%">
                      <tr>
                        <td colspan="3" class="tit">
                          ...
                          <input type="text" id="codigo" name="codigo" placeholder="Ejemplo:PIPT309-3" maxlength="9" title="Coloque el código de la materia 'Ejemplo:PIPT309-3'" onkeypress="return letra_num_car(event)" onclick="validarCODIGO()" onkeyup="validarCODIGO()" onchange="validarCODIGO()" onblur="validarCODIGO()"/>
                  ...
                  <div class="info3">
                    ...
                    <table class="tabla_agregar_imprimir">
                      <tr>
                        <td>
                          <?php
                            $sql="SELECT * FROM horas WHERE taller=1 AND estatus=1";
                    ...
                    <div class="dataTable_wrapper">
                      <table class="table table-striped table-bordered table-hover" id="dataTables-example3">
                        ...
                        <?php
                         ...
                         $sql="SELECT * FROM secciones WHERE taller=1 AND estatus=1";
                    ...
                    <div class="dataTable_wrapper">
                      <table class="table table-striped table-bordered table-hover" id="dataTables-example4">
                        ...
                        <?php
                         ...
                         AND d.id_periodo=x.id_periodo AND d.taller=1 AND d.estatus=1 AND p.estatus=1 GROUP BY d.id_personal,
                    ...
                    <div class="dataTable_wrapper">
                      <table class="table table-striped table-bordered table-hover" id="nueva_tabla">
                        ...
                        <?php
                         ...
                         $sql="SELECT * FROM aulas WHERE estatus=1 AND taller=1";
