                                        ...
                                        <table width="100%">
                                          ...
                                          <tr>
                                            <td>
                                              ...
                                              <textarea name="responsable" id="responsablemod"  class="form-control" style="display:inline-block; width:60%;" size="" maxlength="125" placeholder="Se daño ..." onKeyUp="validarResponsablemod();" onblur="validarResponsablemod();" onKeyPress="return soloAlfa(event)"></textarea>
                                            ...
                                            <td>
                                              ...
                                              <label><b>Proveedor:</b></label><br>
                                                <textarea name="proveedor" id="provedormod"  class="form-control" style="display:inline-block; width:60%;" size="" maxlength="125" placeholder="Jose Hernandez" onKeyUp="validarProveedormod();" onblur="validarProveedormod();" onKeyPress="return soloAlfa(event)"></textarea>
              ...
              <tr>
                <td colspan="">
                  ...
                  <textarea name="responsable" id="responsable" size="" maxlength="125" placeholder="Jose Perez, Juan Perozo ..." onKeyUp="validarResponsable();" onblur="validarResponsable();" onKeyPress="return soloAlfa(event)" style="display:inline-block;"></textarea>
                   <div class="promts" style=""> <span id="responsablePrompt"></span></div><p style="display:inline-block; font-size:30px; position:absolute; color:red;">*</p>
         ...
         <fieldset id="regmaq" style="color:#000;">
          ...
          <tr>
            <td>
              ...
              <div class="promts" style=""> <span id="proveedorPrompt"></span></div><p style="display:inline-block; font-size:30px; position:absolute; color:red;">*</p>
            ...
            <td >
              ...
              <div class="promts" style=""> <span id="responsable2Prompt"></span></div><p style="display:inline-block; font-size:30px; position:absolute; color:red;">*</p>
