<?php
 ...
 #   echo $id;
    ...
    pg_query("UPDATE insumos SET estatus='0' WHERE id_insumos='".$id."'");
    $sqlx="SELECT * FROM  insumos WHERE id_insumos='".$id."' ";
...
#   Actualizamos los rerigistros y los obtenemos
    ...
    $sql="SELECT * FROM insumos WHERE estatus='1' ";
    $query=pg_query($sql);
    ...
    date_default_timezone_set('America/Caracas');
          ...
          pg_query("INSERT INTO auditoria (fecha,accion_realizada,modulo,nom_usuario,taller)
              VALUES('$hoy','Eliminación','Insumos','".$_SESSION['nom_usuario']."',1)");

    header("Location:insumos.php?elim_maq=si");
