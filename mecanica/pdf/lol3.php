...
?>
    ...
    <div class="center">
        <h3 >Reporte de M&aacute;quina</h3>
    </div>
        ...
        <table border="0" style="border-radius:10px;" align="center">
          <tr>
            <td colspan="3" align="center">
                <br>
                <b>Detalle de la M&aacute;quina</b>
                <br>
            </td>
        </tr>
        <tr>
            <td  border="1" class="td_title" width="210" align="center" style="width:0px;">
                <label>Codigo de la M&aacute;quina</label>
            </td>
    ...
    <table border="0" style="border-radius:10px;" align="center">
     ...
     <tr>
         <td border="1"  height="30"> 
             <label>Encargado de la revisi&oacute;n:<u> No </u></label>
         </td>
         <td border="1"> 
             <label>Fecha de revisi&oacute;n: <u> No </u></label>
         </td>
         <td border="1"> 
