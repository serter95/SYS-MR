...
$service=$_REQUEST["tipo_servicio"];
	...
	$sqlm="INSERT INTO mant_correctivo(fecha,id_maquina,id_personal,tipo_servicio,responsable,motivo)
	VALUES('now()','".$id_maq."','".$id_per."','".$service."','".$responsable."','".$motivo."')";
	...
	pg_query("INSERT INTO auditoria (fecha,accion_realizada,modulo,nom_usuario,taller)
		VALUES('$hoy','Registro','Mantenemiento Correctivo','".$_SESSION['nom_usuario']."',1)");
	...
	*/
	...
	$responsable=$_REQUEST["responsable"];
	$sqlm2="INSERT INTO mant_correctivo(fecha,id_maquina,id_personal,tipo_servicio,proveedor,responsable,motivo)
	VALUES('now()','".$id_maq."','".$id_per."','".$service."','".$proveedor."','".$responsable."','".$motivo."')";
	pg_query($sqlm2);
