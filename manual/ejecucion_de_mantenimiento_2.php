...
<head>
    ...
    //<![CDATA[
        drex_file_name = "ejecucion_de_mantenimiento_2.php";
    //]]>
    </script>

    		<title>3.7.2. Ejecuci&#x00F3;n de Mantenimiento</title>
...
<li class="b-breadCrumbs__item">3.7.2. Ejecuci&#x00F3;n de Mantenimiento</li>
</ul>                    </div>
                </td>
                <td id="headerSide__buttons" class="b-article__headerSide m-article__headerSide__buttons">
                    <div class="b-controlButtons">
                        <ul class="b-controlButtons__items">
                            <li class="b-controlButtons__item m-controlButtons__item__prev"><a href="ejecutar_solicitud.php" class="b-controlButtons__link" title="Anterior"><span class="b-controlButtons__link_icon"></span><span class="b-controlButtons__link_text">&#xa0;Anterior</span></a></li>
                            <li class="b-controlButtons__item m-controlButtons__item__next"><a href="preventivo.php" class="b-controlButtons__link" title="Siguiente"><span class="b-controlButtons__link_text">Siguiente&#xa0;</span><span class="b-controlButtons__link_icon"></span></a></li>
                                                </ul>
                    </div>
                </td>
            </tr>
                    ...
                    .append(
                        ...
                        .append(
                            ...
                            .append(
                                ...
                                .html($("<ul></ul>").addClass("b-controlButtons__items").html("    <li class=\"b-controlButtons__item m-controlButtons__item__prev\"><a href=\"ejecutar_solicitud.php\" class=\"b-controlButtons__link\" title=\"Anterior\"><span class=\"b-controlButtons__link_icon\"></span><span class=\"b-controlButtons__link_text\">&#xa0;Anterior</span></a></li>\n    <li class=\"b-controlButtons__item m-controlButtons__item__next\"><a href=\"preventivo.php\" class=\"b-controlButtons__link\" title=\"Siguiente\"><span class=\"b-controlButtons__link_text\">Siguiente&#xa0;</span><span class=\"b-controlButtons__link_icon\"></span></a></li>\n"))
                            )
                        )
                    )
                );
...
<div id="hiddenContent" class="hiddenContent">
    ...
    <div>Para mostrar esto en esta página se necesita que active el JavaScript.</div>
                ...
                <div class="description_on_page"><div class="p" style="text-align: center; direction: ltr; margin-left: 0px; text-indent: 0px;"><div class="ic"><h1><strong>3.7.2. Ejecución de Mantenimiento</strong></h1></div></div>
<div class="p" style="text-align: justify; direction: ltr; margin-left: 0px; text-indent: 0px;">En este Módulo se prodrá Crear, Controlar y Gestionar la ejecución de los mantenimientos de las maquinas&#160; encontradas en el taller (Área de Metalmécanica).</div>
<div class="p" style="text-align: left; direction: ltr; margin-left: 0px; text-indent: 0px;">&#160;</div>
</div>                	<div class="menu_on_page">
		<h2>Contenido 3.7.2. Ejecuci&#x00F3;n de Mantenimiento</h2>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="preventivo.php">3.7.2.1. Preventivo</a></span>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="correctivo.php">3.7.2.2. Correctivo</a></span>
</div>	</div>
