          ...
          <div class="row">
                    ...
                    <div class="dataTable_wrapper">
                      <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                          ...
                          $sql="SELECT * FROM insumos i, numero_bien n WHERE i.n_b=n.id_nb AND i.estatus='1' AND i.taller=1";
                                     ...
                                     <form action="modificar_insumos.php" method="post" id="modif_maqs" name="modif_maqs" onSubmit="return validarmodform()">
                                      ...
                                      <label><b>Ubicación:</b></label><br> 
                                                <select name="ubicacion" id="ubicacionmod" class="form-control" style="width:500px; display:inline-block;"  title="Ingrese la ubicacion del insumo" onclick="validarUbicacion2()" onblur="validarUbicacion2()" onKeyPress="return soloAlfa(event)">
                                                  <option></option>
                                                  <option>Almacén De Maquina de Herramienta</option>
            ...
            <?php
              ...
              ?><!-- <option value="Torno">Torno</option>
                                        ...
                                        <input type="text" name="medida" id="medidamod" maxlength="15" style="width:200px; display:inline-block;" class="form-control" onKeyUp="validarMedidamod()" onBlur="validarMedidamod()"  onKeyPress="return soloAlfa(event)" title="Tamaño medida del insumo">
...
?>
            ...
            <input readonly="readonly" type="text" name="danadas" id="danadasmod" style="width:160px; display:inline-block;" class="form-control" title="Cantidad de insumos dañados">
             ...
             <label><b>Stock Minimo:</b></label>   <br>
        ...
        <form action="registrando_insumos_e&s.php" method="post" id="reg_maquina" name="reg_maquina" onSubmit="return validarForm_SInterno()" enctype="multipart/form-data" >
         ...
         <fieldset id="regmaq" style="color:#000;">
          ...
          <td>
             ...
             <input type="text" name="salida" id="salida_existencia" onblur="calculo_danada_salida(); validarExistenciaSalida();" onkeyup="validarExistenciaSalida();"   onKeyPress="return solonum3(event)">
            <div class="promts" style="z-index:3; margin-left: -79px;"> <span id="existencia2Prompt"></span></div><p style="display:inline-block; font-size:30px; position:absolute; color:red;">*</p>
             ...
             <input readonly="readonly" type="text" name="salida_danadas" id="salida_danadas" maxlength="10" style="margin-left:-50px;" >
        ...
        <br>
         ...
         <input type="hidden" name="tipo" id="tipo" value="registro">
           ...
           <tr>
            ...
            <input type="text" name="medida" id="medida_mil" size="" maxlength="20" onKeyPress="return soloAlfa(event)" onkeyup="validarMedida()" onblur="validarMedida()" title="Tamaño de la medida del insumo"> 
           ...
           <div class="promts"> <span id="medida1Prompt"></span></div><p style="display:inline-block; font-size:30px; position:absolute; color:red;">*</p>
            ...
            <?php            
            $buscar2="SELECT nombre FROM tipo_maquina WHERE estatus=1";
            $query2=pg_query($buscar2);
             while ($array2=pg_fetch_assoc($query2)){
              
              ?>

                <option  value="<?php echo $array2['nombre']; ?>" > <?php echo $array2['nombre']; ?> </option>
          ...
          <tr>
             <td colspan="3" align="right">
              <div style="display:block;"><span style="margin-right:5%; width:20%; color:red; border:1px solid #ccc; border-radius: 4px;   background-color: #fff; padding: 6px 12px; font-size: 14px;">* Campos Requeridos</span></div>
            </td>
          </tr>
           <tr>
            <td colspan="3" align="center">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <table class="table table-striped table-bordered table-hover" >
                <thead>
                          <tr>
                            <th width="200px">Numero del Bien</th>
                            <th>Nombre</th>
                          </tr>
...
$sqlmin="SELECT * FROM insumos i, numero_bien n WHERE i.n_b=n.id_nb AND i.existencia <= i.min_stock  AND i.estatus=1 AND  i.taller=1";

$querymin=pg_query($sqlmin);

while($encontrado2=pg_fetch_assoc($querymin)){
$insumo2=$insumo2."<tr><td>".$encontrado2["nb"]."</td><td>".$encontrado2["nombre"]."</td></tr>";
}
