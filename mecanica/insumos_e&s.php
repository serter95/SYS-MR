                    ...
                    <div id="tabla_salida">
                      <div class="dataTable_wrapper">
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                          ...
                          <tbody>
                            <?php
                            $sql="SELECT * FROM insumos i , salida s WHERE i.id_insumos=s.id_insumos AND s.tipo='insumo' AND i.taller=1 AND i.estatus=1 AND s.estatus=1";
                  ...
                  <div id="tabla_entrada">
                    <div class="dataTable_wrapper">
                      <table class="table table-striped table-bordered table-hover" id="dataTables-example2">
                        ...
                        <tbody>
                          <?php
                          $sql2="SELECT * FROM insumos i, entrada e WHERE i.id_insumos=e.id_insumos AND e.tipo='insumo' AND i.taller=1 AND i.estatus=1 AND e.estatus=1";
        ...
        <div id="entrada">
          <form action="registrando_insumos_e&s.php" method="post" id="reg_maquina" name="reg_maquina" onSubmit="return validarForm_E();" enctype="multipart/form-data">
           ...
           <fieldset id="regmaq" style="color:#000;">
             ...
             <input type="text" style="text-transform:capitalize;" name="codigo" id="codigo"  maxlength="10" placeholder="Ejemplo:To-00" title="Código del insumo" onkeyup="existeCodigoE();" onblur="buscar_insumo(); existeCodigoE();" />
            ...
            <td>
             ...
             <input readonly="readonly" type="text" name="entrada_danadas" id="entrada_danadas" maxlength="10" style="margin-left:-50px;" >
       ...
       <div id="salida">
        <form action="registrando_insumos_e&s.php" method="post" id="reg_maquina" name="reg_maquina" onSubmit="return validarForm_S()" enctype="multipart/form-data" >
         ...
         <fieldset id="regmaq" style="color:#000;">
           ...
           <td>
           <label><b>Codigo del insumo:</b></label>
           <input type="text" style="text-transform:capitalize;" name="codigo" id="codigo2"  maxlength="10" placeholder="Ejemplo:To-00" title="Código del insumo" onblur="buscar_insumo(); existeCodigoS();" onkeyup="existeCodigoS();" />
