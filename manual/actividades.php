...
<head>
    ...
    //<![CDATA[
        drex_file_name = "actividades.php";
    //]]>
    </script>

    		<title>3.8. Actividades</title>
...
<li class="b-breadCrumbs__item">3.8. Actividades</li>
</ul>                    </div>
                </td>
                <td id="headerSide__buttons" class="b-article__headerSide m-article__headerSide__buttons">
                    <div class="b-controlButtons">
                        <ul class="b-controlButtons__items">
                            <li class="b-controlButtons__item m-controlButtons__item__prev"><a href="reposicion_de_repuestos_2.php" class="b-controlButtons__link" title="Anterior"><span class="b-controlButtons__link_icon"></span><span class="b-controlButtons__link_text">&#xa0;Anterior</span></a></li>
                            <li class="b-controlButtons__item m-controlButtons__item__next"><a href="planificacion_semanal.php" class="b-controlButtons__link" title="Siguiente"><span class="b-controlButtons__link_text">Siguiente&#xa0;</span><span class="b-controlButtons__link_icon"></span></a></li>
                                                </ul>
                    </div>
                </td>
            </tr>
                    ...
                    .append(
                        ...
                        .append(
                            ...
                            .append(
                                ...
                                .html($("<ul></ul>").addClass("b-controlButtons__items").html("    <li class=\"b-controlButtons__item m-controlButtons__item__prev\"><a href=\"reposicion_de_repuestos_2.php\" class=\"b-controlButtons__link\" title=\"Anterior\"><span class=\"b-controlButtons__link_icon\"></span><span class=\"b-controlButtons__link_text\">&#xa0;Anterior</span></a></li>\n    <li class=\"b-controlButtons__item m-controlButtons__item__next\"><a href=\"planificacion_semanal.php\" class=\"b-controlButtons__link\" title=\"Siguiente\"><span class=\"b-controlButtons__link_text\">Siguiente&#xa0;</span><span class=\"b-controlButtons__link_icon\"></span></a></li>\n"))
                            )
                        )
                    )
                );
...
<div id="hiddenContent" class="hiddenContent">
    ...
    <div>Para mostrar esto en esta página se necesita que active el JavaScript.</div>
                ...
                <div class="description_on_page"><div class="p" style="text-align: center; direction: ltr; margin-left: 0px; text-indent: 0px;"><div class="ic"><h1><strong>3.8. Actividades</strong></h1></div></div>
<div class="p" style="text-align: left; direction: ltr; margin-left: 0px; text-indent: 0px;">En este Módulo se prodrá Crear, Controlar y Gestionar las planificación semanal y los registros diarios en el área.</div>
<div class="p" style="text-align: left; direction: ltr; margin-left: 0px; text-indent: 0px;">&#160;</div>
</div>                	<div class="menu_on_page">
		<h2>Contenido 3.8. Actividades</h2>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="planificacion_semanal.php">3.8.1. Planificaci&#x00F3;n Semanal</a></span>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="registro_diario.php">3.8.2. Registro Diario</a></span>
</div>	</div>
