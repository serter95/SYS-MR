...
<head>
    ...
    //<![CDATA[
        drex_file_name = "secciones.php";
    //]]>
    </script>

    		<title>3.1.2. Secciones</title>
...
<li class="b-breadCrumbs__item">3.1.2. Secciones</li>
</ul>                    </div>
                </td>
                <td id="headerSide__buttons" class="b-article__headerSide m-article__headerSide__buttons">
                    <div class="b-controlButtons">
                        <ul class="b-controlButtons__items">
                            <li class="b-controlButtons__item m-controlButtons__item__prev"><a href="eliminar_materia.php" class="b-controlButtons__link" title="Anterior"><span class="b-controlButtons__link_icon"></span><span class="b-controlButtons__link_text">&#xa0;Anterior</span></a></li>
                            <li class="b-controlButtons__item m-controlButtons__item__next"><a href="agregar_seccion.php" class="b-controlButtons__link" title="Siguiente"><span class="b-controlButtons__link_text">Siguiente&#xa0;</span><span class="b-controlButtons__link_icon"></span></a></li>
                                                </ul>
                    </div>
                </td>
            </tr>
                    ...
                    .append(
                        ...
                        .append(
                            ...
                            .append(
                                ...
                                .html($("<ul></ul>").addClass("b-controlButtons__items").html("    <li class=\"b-controlButtons__item m-controlButtons__item__prev\"><a href=\"eliminar_materia.php\" class=\"b-controlButtons__link\" title=\"Anterior\"><span class=\"b-controlButtons__link_icon\"></span><span class=\"b-controlButtons__link_text\">&#xa0;Anterior</span></a></li>\n    <li class=\"b-controlButtons__item m-controlButtons__item__next\"><a href=\"agregar_seccion.php\" class=\"b-controlButtons__link\" title=\"Siguiente\"><span class=\"b-controlButtons__link_text\">Siguiente&#xa0;</span><span class=\"b-controlButtons__link_icon\"></span></a></li>\n"))
                            )
                        )
                    )
                );
...
<div id="hiddenContent" class="hiddenContent">
    ...
    <div>Para mostrar esto en esta página se necesita que active el JavaScript.</div>
                ...
                <div class="description_on_page"><div class="p" style="text-align: center; direction: ltr; margin-left: 0px; text-indent: 0px;"><div class="ic"><h1><strong>3.1.2. Secciones</strong></h1></div></div>
<div class="p" style="text-align: left; direction: ltr; margin-left: 0px; text-indent: 0px;">En este Módulo se prodrá Crear, Modificar y Eliminar las secciones.</div>
</div>                	<div class="menu_on_page">
		<h2>Contenido 3.1.2. Secciones</h2>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="agregar_seccion.php">3.1.2.1. Agregar Secci&#x00F3;n</a></span>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="modificar_seccion.php">3.1.2.2. Modificar Secci&#x00F3;n</a></span>
</div><div class="m-workZone_seeAlso_itemContent">
	<span class="b-tree__spacer">
		<span class="b-tree__i_article">
			<span class="b-tree__i_article_inner"></span>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="eliminar_seccion.php">3.1.2.3. Eliminar Secci&#x00F3;n</a></span>
</div>	</div>
