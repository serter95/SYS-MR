                    ...
                    <tr>
                      ...
                      <?php
                        ...
                        $query=pg_query("SELECT * FROM personal INNER JOIN usuario
                          ...
                          AND nom_usuario='".$_SESSION['nom_usuario']."' AND taller=2" );
                  ...
                  <div class="dataTable_wrapper">
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                      ...
                      <?php
                        ...
                        {
                          $sql="SELECT * FROM registro_diario INNER JOIN (personal INNER JOIN usuario ON personal.id=usuario.id_personal AND nom_usuario='".$_SESSION['nom_usuario']."' AND personal.estatus=1 AND usuario.estatus=1) ON registro_diario.id_personal=personal.id AND registro_diario.estatus=1 AND personal.estatus=1 AND area='Robotica'";
                        }
