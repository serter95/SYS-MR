                ...
                <div  id="tabla_usuario">
                  ...
                  <div class="dataTable_wrapper">
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                      ...
                      <tbody>
                        <?php
                        $sql="SELECT * FROM herramientas h, numero_bien n WHERE h.n_b=n.id_nb AND h.estatus=1 AND h.taller=2";
                              ...
                              <table width="100%">
                                ...
                                <tr>
                                  ...
                                  <td colspan="2" align="center">
                                    ...
                                    <div class="promts" style="margin-left:0px;"> <span id="CodemodPrompt"></span></div>
                                    <br><br>
                                  </td>
                                </tr>
                                <tr>
                                  <td align="center">
                                    ...
                                    <textarea type="text" name="nombre" id="nombremod" class="form-control input_size" style="resize:none; height:40px; display:inline-block; " maxlength="100" onkeyup="validarM_Nombre()" onblur="validarM_Nombre()" onKeyPress="return soloAlfa(event)"></textarea> 
                           ...
                           <table width="100%">
                             <tr>
                              <td align="center">
                                ...
                                <input type="text" name="serial" id="serialmod" class="form-control input_size" maxlength="6" onKeyUp="existeSerial2()" onblur="existeSerial2()"  onKeyPress="return solonum3(event)">
                   ...
                   <table width="100%">
                     <tr>
                      ...
                      <td>
                       ...
                       <input readonly="readonly" type="text" name="nombre" id="nombreP">
                     </td>
                   </tr>
                   <tr>
                     <td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <h4>¿Usted esta seguro de que desea generar el reporte de las herramienta?</h4>                            
      ...
      <div class="modal-footer">
        ...
        <button class="btn btn-primary" title="Aceptar" onclick="reporte_Herramientas()" data-dismiss="modal" >Aceptar</button>
        <button class="btn btn-danger" data-dismiss="modal" title="Cancelar">Cancelar</button>
             ...
             <table width="100%">
              ...
              <tr>
                <td width="33%"  align="center">
                  ...
                  <div class="promts" style="margin-left:5px;"> <span id="CodePrompt"></span></div>
              ...
              <tr>
                ...
                <td width="33%" align="center">
                  ...
                  <input type="text" name="serial" id="serial" maxlength="6" onKeyUp="existeSerial()" onblur="existeSerial()"  onKeyPress="return solonum3(event)">
