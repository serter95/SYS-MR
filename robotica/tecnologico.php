          ...
          <div class="row">
            <div class="col-lg-9 main-chart">
              ...
              <div id="consulta_tecnologico">
                ...
                <h4><a href="#">Académico</a> > <a href="proyectos.php">Proyectos</a> > <a href="#">Socio-Tecnológicos</a></h4>

                <div class="info3">
                  <div id="text_center_title">
                    <span class="t-menu">Consulta de Socio-Tecnológicos</span>
                  </div><br>
                    ...
                    <!--    <p id=""><button class="btn btn-default">Generar Reporte &nbsp; <span class="fa fa-file-text-o"></span></button></p>-->
                      ...
                      <td>
                        <?php
                          ...
                          {
                        ?>
                        <p id="agregar_per"><button class="btn btn-success" onclick="N_tecnologico()">Nuevo Proyecto Socio-Tecnológico &nbsp; <i class="fa fa-plus"></i></button></p>
                        <?php
                          }
                        ?>
                      </td>
                  ...
                  <div class="dataTable_wrapper">
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                      ...
                      <?php
                       ...
                       $sql="SELECT * FROM proyectos WHERE ambito='tecnologico' AND taller=2 AND estatus=1";
              ...
              <div id="registro_tecnologico">
                ...
                <h4><a href="#">Académico</a> > <a href="proyectos.php">Proyectos</a> > <a href="tecnologico.php">Socio-Tecnológicos</a> > <a href="#">Nuevo Proyecto Socio-Tecnológico</a></h4>

                <div class="info3">
                  <div id="text_center_title">
                    <span class="t-menu">Registro de Proyectos Socio-Tecnológicos</span>
                  </div><br>

                  <form method="post" action="registro_tecnologico.php" id="reg_tecnologico" onsubmit=" return validarPROYECTO()">
                                  ...
                                  <table width="100%">
                                    <tr>
                                      ...
                                      <td class="tit">
                                        ...
                                        <input type="text" name="codigo" id="codigo" maxlength="21" placeholder="Ejemplo:PNFIV-0-00-0000" title="Coloque el código del proyecto 'Ejemplo:PNFIV-0-00-0000'" onkeypress="return soloCodigo(event)" onclick="validarCODIGO()" onkeyup="validarCODIGO()" onchange="validarCODIGO()"/>      
                                        <p style="display:inline-block; font-size:30px; position:absolute; color:red;">*</p>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <h4 class="modal-title">Modificar Proyecto Socio-Tecnológico</h4>
                      </div>
                      <div class="modal-body">

                        <form method="post" action="modifica_tecnologico.php" id="modif_planif" onsubmit="return validarPROYECTO_M()">
                                    ...
                                    <div class="table-responsive">
                                      ...
                                      <table width="100%">
                                        <tr>
                                          ...
                                          <td class="tit">
                                            <label><b>Código:</b></label><br>
                                            <input type="text" name="codigoM" id="codigoM" maxlength="21" placeholder="Ejemplo:PNFIV-0-00-0000" title="Código del proyecto 'Ejemplo:PNFIV-0-00-0000'" title="Coloque el código del proyecto" onkeypress="return soloCodigo(event)" onclick="validarCODIGO_M()" onkeyup="validarCODIGO_M()" onchange="validarCODIGO_M()"/>      
                                            <p style="display:inline-block; font-size:30px; position:absolute; color:red;">*</p>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <h4 align="center">¿Usted esta seguro que desea cambiar el estado del Proyecto a "Concluido"?
                          <br><br>¡Si acepta realizar este cambio después no podrá realizar ninguna modificación ni eliminar el Proyecto seleccionado!</h4>                            
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        ...
                        <input type="hidden" id="comunitario" value="tecnologico">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header" id="exito">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true" title="Cerrar">&times;</button>
                        <h4 class="modal-title">Registro de Proyecto Socio-Tecnológico</h4>
                      </div>
                      <div class="modal-body">
...
?>       
    ...
    <script type="text/javascript" src="js/vali_proyecto.js"></script>
</body>
</html>
<?php
