...
-->
                    <div id="text_center_title">
                      ...
                      <div style="margin-left:16%; margin-top:2%;">
                        ...
                        <form action="pdf/reporte_insumos.php" method="get" target="_blank" style="display:inline">
                         <div class="box1" style="display:inline-block; border-bottom:0px; margin-left:15%;"> 
                         <select name="tipo" id="select_insuReport" style="color:#000;" onchange="vali_insu_report(); vali_insu_boton();">
                           <option value="todos">Todos</option>
                           <option value="nombre">Nombre</option>
                           <option value="precio">Precio</option>
                           <option value="existencia">Poca existencia</option>
                         </select>
                         <input type="text" id="insumoReport" style="width:100px; color:#000;" onkeyup="vali_insu_boton()" onblur="vali_insu_boton()" name="valor" maxlength="10">
                        <div class="promts" style="margin-left:1px"> <span style="font-size:15px;" id="insuPrompt"></span></div>
                      ...
                      <!--  <a href="pdf/reporte_insumos.php" target="_blank">
                          ...
                          <h4>Insumos</h4>
                          <input type="submit" id="boton_insumo" value="Visualizar" style="color:#000;">
                        </div>
                        </form>
                      ...
                      <div style="margin-left:20%; margin-top:2%;">
                        ...
                        <a href="#">
                         ...
                         <div class="box1" style="display:inline-block; border-bottom:0px; margin-left:15%;"> 
                          ...
                          <select id="SelectTipoInsumo" style="color:#000;">
                          ...
                          <h4>Insumos Entradas y Salidas</h4>
                          <button id="visualizar_insu" style="color:#000;">Visualizar</button>
                        </div>
                      </div>
                    </div>
                    </div>
                     ...
                     <div style="margin-left:8%; margin-top:2%;">
                      <div class="box1" style="display:inline-block; border-bottom:0px; margin-left:15%;"> 
                        <a href="pdf/reporte_tornos_completo.php" target="_blank">
                        ...
                        <div class="box1" style="display:inline-block; border-bottom:0px; margin-left: 15%;"> 
                          <a href="pdf/reporte_esmeriles.php" target="_blank">
                          ...
                          <div class="box1" style="display:inline-block; border-bottom:0px; margin-left: 15%;"> 
                            <a href="pdf/reporte_limadoras.php" target="_blank">
                            ...
                            <div class="box1" style="border-bottom:0px; display:inline-block; margin-left:12%;"> 
                              <a href="pdf/reporte_fresadoras.php" target="_blank">
                              ...
                              <div class="box1" style="display:inline-block; border-bottom:0px; margin-left:13%;"> 
                                <a href="pdf/reporte_taladros.php" target="_blank">
                                    <span style="color: #333;" class="fa fa-file-text-o"></span> 
                                  </a>
                                  <h4>Taladro</h4>
                                </div>
...
$('#visualizar_insu').click(function(){
  var desde= document.getElementById('desde').value;
   var hasta= document.getElementById('hasta').value;
   var tipo=document.getElementById('SelectTipoInsumo').value;
        window.open("pdf/reporte_insumo_e&s.php?tipo="+tipo+"&desde="+desde+"&hasta="+hasta+"","_blank");
...
function reporte_mantenimiento_correctivo_rango(){
  ...
  if (existeCodigo2()==false){
    ...
    document.getElementById('form_correctivo').submit();
      ...
      document.getElementById('insumoReport').disabled=true;


  function vali_insu_report(){
    var valor=document.getElementById('select_insuReport').value;
    if(valor=="todos"){
      $('#insumoReport').val("");
      document.getElementById('insumoReport').disabled=true;
      //$('#insumoReport').attr('onkeypress','return soloAlfa(event)');
      $('#insuPrompt').html("");
      return true;
  }
  else if (valor=="nombre"){
     $('#insumoReport').val("");
      document.getElementById('insumoReport').disabled=false;
      $('#insumoReport').attr('onkeypress','return soloAlfax(event)');
      $('#insuPrompt').html("Introduzca solo letras");
  }
   else if (valor=="precio"){
     $('#insumoReport').val("");
      document.getElementById('insumoReport').disabled=false;
      $('#insumoReport').attr('onkeypress','return solonum(event)');
      $('#insuPrompt').html("Introduzca solo numeros");
  }
...
//especiales=[''];
    ...
    function vali_insu_boton(){
         var select=document.getElementById('select_insuReport').value;
         var valor=document.getElementById('insumoReport').value;
      if (select=="todos"){
        document.getElementById('boton_insumo').disabled=false;
      }
      else if(select=="existencia"){
