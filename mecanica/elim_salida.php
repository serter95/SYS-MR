<?php
 ...
 #   echo $id;
    ...
    pg_query("UPDATE salida SET estatus='0' WHERE id_salida='".$id."'");
    //pg_query("DELETE FROM maquinas WHERE id_maquina='".$id."'");
#   Actualizamos los rerigistros y los obtenemos

    $sql="SELECT * FROM salida WHERE estatus='1' ";
    $query=pg_query($sql);
    ...
    date_default_timezone_set('America/Caracas');
          ...
          pg_query("INSERT INTO auditoria (fecha,accion_realizada,modulo,nom_usuario,taller)
              VALUES('$hoy','Eliminación','Salida','".$_SESSION['nom_usuario']."',1)");

    header("Location:insumos_e&s.php?elim_maq=si");
    }
...
#   Actualizamos los rerigistros y los obtenemos
    ...
    header("Location:herramientas_e&s.php?elim_maq=si");
    }
