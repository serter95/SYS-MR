...
//$datos = pg_query ($conexion, "SELECT * FROM usuario");
$datos=pg_query("SELECT * FROM maquinas m, numero_bien n WHERE maquina='Fresadora' AND m.n_b=n.id_nb AND estatus='1'");
...
$html2pdf -> Output('reporte_fresadoras_'.$d.'-'.$m.'-'.$y.'.pdf','I');
?>