      ...
      <section id="main-content">
        <section class="wrapper">
          <div class="row">
                    ...
                    <div class="dataTable_wrapper">
                      <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                          ...
                          $sql="SELECT * FROM convenios WHERE estatus='1' AND taller=1";
            ...
            <input type="text" class="form-control" style="width:60%; display:inline-block" name="titulo" id="titulomod"  maxlength="100" placeholder="Ejem: Convenio Ferremetal con Metalmecánica" title="Titulo del convenio" onKeyUp="existeTitulo2();" onblur="existeTitulo2();" />
