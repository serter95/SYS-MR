...
<head>
    ...
    //<![CDATA[
        drex_file_name = "correctivo.php";
    //]]>
    </script>

    		<title>3.7.2.2. Correctivo</title>
...
<li class="b-breadCrumbs__item">3.7.2.2. Correctivo</li>
</ul>                    </div>
                </td>
                <td id="headerSide__buttons" class="b-article__headerSide m-article__headerSide__buttons">
                    <div class="b-controlButtons">
                        <ul class="b-controlButtons__items">
                            <li class="b-controlButtons__item m-controlButtons__item__prev"><a href="reportes_solicitud_2.php" class="b-controlButtons__link" title="Anterior"><span class="b-controlButtons__link_icon"></span><span class="b-controlButtons__link_text">&#xa0;Anterior</span></a></li>
                            <li class="b-controlButtons__item m-controlButtons__item__next"><a href="ejecutar_mantenimiento_2.php" class="b-controlButtons__link" title="Siguiente"><span class="b-controlButtons__link_text">Siguiente&#xa0;</span><span class="b-controlButtons__link_icon"></span></a></li>
                                                </ul>
                    </div>
                </td>
            </tr>
                    ...
                    .append(
                        ...
                        .append(
                            ...
                            .append(
                                ...
                                .html($("<ul></ul>").addClass("b-controlButtons__items").html("    <li class=\"b-controlButtons__item m-controlButtons__item__prev\"><a href=\"reportes_solicitud_2.php\" class=\"b-controlButtons__link\" title=\"Anterior\"><span class=\"b-controlButtons__link_icon\"></span><span class=\"b-controlButtons__link_text\">&#xa0;Anterior</span></a></li>\n    <li class=\"b-controlButtons__item m-controlButtons__item__next\"><a href=\"ejecutar_mantenimiento_2.php\" class=\"b-controlButtons__link\" title=\"Siguiente\"><span class=\"b-controlButtons__link_text\">Siguiente&#xa0;</span><span class=\"b-controlButtons__link_icon\"></span></a></li>\n"))
                            )
                        )
                    )
                );
...
<div id="hiddenContent" class="hiddenContent">
    ...
    <div>Para mostrar esto en esta página se necesita que active el JavaScript.</div>
                ...
                <div class="description_on_page"><div class="p" style="text-align: center; direction: ltr; margin-left: 0px; text-indent: 0px;"><div class="ic"><h1><strong>3.7.2.2. Correctivo</strong></h1></div></div>
<div class="p" style="text-align: justify; direction: ltr; margin-left: 0px; text-indent: 0px;">En esté tema se presentará como Ejecutar, Modificar, Eliminar, Detallar y dar un Reporte de un mantenimiento correctivo a las maquinas disponibles en el taller.</div>
</div>                	<div class="menu_on_page">
		<h2>Contenido 3.7.2.2. Correctivo</h2>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="ejecutar_mantenimiento_2.php">3.7.2.2.1. Ejecutar Mantenimiento</a></span>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="modificar_mantenimiento_2.php">3.7.2.2.2. Modificar Mantenimiento</a></span>
</div><div class="m-workZone_seeAlso_itemContent">
	<span class="b-tree__spacer">
		<span class="b-tree__i_article">
			<span class="b-tree__i_article_inner"></span>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="eliminar_mantenimiento_2.php">3.7.2.2.3. Eliminar Mantenimiento</a></span>
</div><div class="m-workZone_seeAlso_itemContent">
	<span class="b-tree__spacer">
		<span class="b-tree__i_article">
			<span class="b-tree__i_article_inner"></span>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="detalle_ejecucion_2.php">3.7.2.2.4. Detalle Ejecuci&#x00F3;n</a></span>
</div><div class="m-workZone_seeAlso_itemContent">
	<span class="b-tree__spacer">
		<span class="b-tree__i_article">
			<span class="b-tree__i_article_inner"></span>
	...
	<span class="b-tree__itemText"><a class="b-breadCrumbs__link" href="reportes_solicitud_3.php">3.7.2.2.5. Reportes Solicitud</a></span>
</div>	</div>
