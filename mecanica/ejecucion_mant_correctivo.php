                                 ...
                                 <tr>
                                   <tr>
                                    <td colspan="2">                                     
                                      ...
                                      <input type="text" name="fecha_falla" id="fechamod" style="width:180px; display: inline-block;"  class="form-control"  size="" maxlength="10" placeholder="00-00-0000" onclick="valida_fechamod();" onblur="valida_fechamod();" disabled>
            ...
            <table width="100%">
              ...
              <tr>
                 <td colspan="2" align="center">
                  ...
                  <textarea  readonly="readonly"  name="motivo" id="motivo" class="form-control" style="display: inline-block; width:160px; margin-left:-50px" size="" maxlength="30" placeholder="" onKeyPress="return soloLetras(event)" ></textarea>
                </td>
      ...
      <tr>
        ...
        <td colspan="">
         ...
         <td colspan="" align="center">
                  <label  style="margin-left:-50px;"><b>Motivo:</b></label><br>
                  <textarea  readonly="readonly"  name="motivo" id="motivo2" class="form-control" style="display: inline-block; width:160px; margin-left:-50px" size="" maxlength="30" placeholder="" onKeyPress="return soloLetras(event)" ></textarea>
                </td>
