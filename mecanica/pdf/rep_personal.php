...
$personal=pg_query("SELECT * FROM personal WHERE estatus='1' AND area='Mecanica'");
$total_personal=pg_num_rows($personal);

$masculino=pg_query("SELECT * FROM personal WHERE estatus='1' AND area='Mecanica' AND sexo='M'");
$personal_masculino=pg_num_rows($masculino);

$femenino=pg_query("SELECT * FROM personal WHERE estatus='1' AND area='Mecanica' AND sexo='F'");
$personal_femenino=pg_num_rows($femenino);

$escolar=pg_query("SELECT * FROM personal WHERE estatus='1' AND area='Mecanica' AND grado_instruccion='Escolar'");
$t_escolar=pg_num_rows($escolar);

$bachiller=pg_query("SELECT * FROM personal WHERE estatus='1' AND area='Mecanica' AND grado_instruccion='Bachiller'");
$t_bachiller=pg_num_rows($bachiller);

$medio_tecnico=pg_query("SELECT * FROM personal WHERE estatus='1' AND area='Mecanica' AND grado_instruccion='Medio Técnico'");
$t_medio_tecnico=pg_num_rows($medio_tecnico);

$TSU=pg_query("SELECT * FROM personal WHERE estatus='1' AND area='Mecanica' AND grado_instruccion='TSU'");
$t_TSU=pg_num_rows($TSU);

$profesor=pg_query("SELECT * FROM personal WHERE estatus='1' AND area='Mecanica' AND grado_instruccion='Profesor'");
$t_profesor=pg_num_rows($profesor);

$licenciado=pg_query("SELECT * FROM personal WHERE estatus='1' AND area='Mecanica' AND grado_instruccion='Licenciado'");
$t_licenciado=pg_num_rows($licenciado);

$ingeniero=pg_query("SELECT * FROM personal WHERE estatus='1' AND area='Mecanica' AND grado_instruccion='Ingeniero'");
$t_ingeniero=pg_num_rows($ingeniero);

$diplomado=pg_query("SELECT * FROM personal WHERE estatus='1' AND area='Mecanica' AND grado_instruccion='Diplomado'");
$t_diplomado=pg_num_rows($diplomado);

$especializacion=pg_query("SELECT * FROM personal WHERE estatus='1' AND area='Mecanica' AND grado_instruccion='Especialización'");
$t_especializacion=pg_num_rows($especializacion);

$magister=pg_query("SELECT * FROM personal WHERE estatus='1' AND area='Mecanica' AND grado_instruccion='Magister'");
$t_magister=pg_num_rows($magister);

$doctorado=pg_query("SELECT * FROM personal WHERE estatus='1' AND area='Mecanica' AND grado_instruccion='Doctorado'");
$t_doctorado=pg_num_rows($doctorado);

$phd=pg_query("SELECT * FROM personal WHERE estatus='1' AND area='Mecanica' AND grado_instruccion='Phd'");
