...
<meta name="description" content="Demo de la aplicación web para el control y gestion académica y administrativa para el taller de metalmecánica y laboratorio de robótica de UPT-Aragua 'Federico Brito Figueroa' (Metalmecánica)">
			...
			<div id="areadetrabajo" align="center">
				...
				<div id="div_convenios" class="dataTable_wrapper" style="margin-left:-5%; display:none;">
					<?php include("conexion.php"); ?>
						<?php 
						$query=pg_query("SELECT * FROM convenios WHERE estatus=1 AND taller=1");
				...
				<div id="div_proyectos" class="dataTable_wrapper" style="margin-left:-5%; display:none;">
					<?php include("conexion.php"); 
						...
						$query=pg_query("SELECT * FROM proyectos WHERE estatus=1 AND taller=1 ORDER BY codigo ASC"); 
					?>
	          ...
	          <div id="div_horarios" class="dataTable_wrapper" style="margin-left:-5%; display:none;">
                          ...
                          while ($array=pg_fetch_assoc($query))
                          {
                            ...
                            <tr class="odd gradeX">
                             ...
                             <td align="center">
                              ...
                              <a href="javascript:reportando_Horario(<?php echo $array['id_seccion'].','.$array['id_periodo'].',1';?>);">
				...
				<div id="div_profesor" class="dataTable_wrapper" style="margin-left:-7%; margin-top:10%; display:none;">
					...
					<table width="400px">
	                    ...
	                    <div class="icono">
	                    	<span onclick="rep_prof('1')" id="prof" class="fa fa-print"></span>
	                    	<h4>Ver Reporte</h4>
	                    </div>
	                </div>
