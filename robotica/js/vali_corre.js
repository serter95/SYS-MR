...
function valida_fechamod(){
  ...
  var valor2 = document.getElementById("resultado_fechamod").value;
    ...
    {
  //validaCodigo dunciona para todos WTF  aqui iba !validarCodigo() ||
  if( !validarResponsablemod() || !validarProveedormod() || !valida_fechamod() || !validarFallamod() || !validarObservacionesmod() || !validarArranquemod() || !validarHombremod() || !validarCostomod() ){
        /*$('#error_incompleto').modal({
                    show:true,
                    backdrop:'static'
                }).show(200);
