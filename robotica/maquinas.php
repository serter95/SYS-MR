...
require('conexion.php');
  $sql2="SELECT * FROM tipo_usuario INNER JOIN usuario ON tipo_usuario.id_tipo = usuario.id_tipo_usuario
    AND nom_usuario='".$_SESSION['nom_usuario']."' LIMIT 1";
                              ...
                              <div class="panel-body">
                                <form action="modificar_maquina.php" method="post" id="modif_maqs" name="modif_maqs" onSubmit="return validarmodform()" enctype="multipart/form-data">
                                  <fieldset id="mod_usuario" style="  margin-left: 10%;">
                                    ...
                                    <input type="text" name="modelo" id="Mmodelo" maxlength="20" class="form-control input_size" onKeyUp="validarM_Modelo()" onBlur="validarM_Modelo()" onchange="validarM_Modelo()" onkeyPress='return soloAlfa(event);' onpaste="return false"/>
                                    <p style="display:inline-block; font-size:30px; position:absolute; color:red;">*</p>
                                    ...
                                    <input type="text" name="marca" id="Mmarca" maxlength="20" class="form-control input_size" onKeyUp="validarM_Marca()" onBlur="validarM_Marca()" onchange="validarM_Marca()" onkeyPress='return soloAlfa(event);'  onpaste="return false"/>
                                    <p style="display:inline-block; font-size:30px; position:absolute; color:red;">*</p>
