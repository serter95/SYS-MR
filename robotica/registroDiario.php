<?php
	...
	if ($actividad!='existe')
	{
		$query=pg_query("SELECT * FROM personal INNER JOIN usuario ON personal.id=usuario.id_personal AND personal.estatus=1 AND usuario.estatus=1 AND usuario.nom_usuario='".$_SESSION['nom_usuario']."' AND usuario.taller=2");
	    ...
	    VALUES('$hoy','Registro','Registro Diario','".$_SESSION['nom_usuario']."')");
